    ...
    <>
      ...
      <div className="mt-10 space-y-10">
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">1. 収益化の方法</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">2. 表記について</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">3. 記事内容への影響</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">4. 第三者からの提供・取材</h2>
