      ...
      <div className="container mx-auto px-4 md:max-w-4xl">
        <Reveal>
          <header className="mb-10">
            <p className="text-[10px] font-semibold tracking-[0.3em] text-tiffany-400">HUB</p>
            <h1 className="serif-heading mt-2 text-3xl text-slate-100">売却相場HUB</h1>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="serif-heading text-xl text-slate-100">最短チェック</h2>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <GlassCard className="border border-slate-800 bg-slate-900/60 p-5 text-slate-200 shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-tiffany-300">POINT</p>
              ...
              <GlassCard className="border border-slate-800 bg-slate-900/60 p-5 text-slate-200 shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-tiffany-300">CAUTION</p>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="serif-heading text-xl text-slate-100">次に読む</h2>
            <p className="mt-2 text-[12px] leading-relaxed text-slate-400">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full border border-slate-700 bg-slate-900/70 px-4 py-2 text-[11px] font-semibold tracking-[0.18em] text-slate-200 hover:border-tiffany-300 hover:text-tiffany-200"
              >
                査定前の準備へ
              </Link>
              <Link
