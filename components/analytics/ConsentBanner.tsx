...
export function ConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[90] px-4 pb-4 sm:pb-6">
      <div className="mx-auto max-w-3xl overflow-hidden rounded-[24px] border border-[var(--border-default)] bg-[rgba(251,248,243,0.94)] shadow-[0_18px_44px_rgba(14,12,10,0.12)] backdrop-blur">
        <div className="flex flex-col gap-4 p-4 sm:flex-row sm:items-end sm:justify-between sm:gap-6 sm:p-5">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            <button
              type="button"
              onClick={deny}
              className="inline-flex min-h-[42px] items-center justify-center rounded-full border border-[var(--border-default)] bg-[rgba(251,248,243,0.92)] px-4 text-[12px] font-semibold tracking-[0.08em] text-[var(--text-secondary)] transition hover:border-[rgba(14,12,10,0.16)] hover:text-[var(--text-primary)]"
            >
              拒否
            </button>
            <button
              type="button"
              onClick={accept}
              className="inline-flex min-h-[42px] items-center justify-center rounded-full border border-[rgba(27,63,229,0.24)] bg-[rgba(27,63,229,0.12)] px-4 text-[12px] font-semibold tracking-[0.08em] text-[var(--accent-strong)] transition hover:border-[rgba(27,63,229,0.34)] hover:bg-[rgba(27,63,229,0.18)]"
            >
              許可
            </button>
          </div>
