  ...
  return (
    ...
    >
      <div className="absolute inset-0 h-full w-full">
        ...
        />
        {rightLabel && (
          <div className="absolute bottom-4 right-4 z-10 rounded-full border border-[rgba(141,126,114,0.26)] bg-[rgba(251,248,243,0.88)] px-4 py-1.5 text-[10px] font-semibold tracking-[0.16em] text-[var(--text-primary)] backdrop-blur-sm">
            {rightLabel}
          </div>
        )}
      </div>
      ...
      >
        ...
        />
        {leftLabel && (
          <div className="absolute bottom-4 left-4 z-10 rounded-full border border-[rgba(135,152,166,0.22)] bg-[rgba(229,235,239,0.88)] px-4 py-1.5 text-[10px] font-semibold tracking-[0.16em] text-[var(--text-primary)] backdrop-blur-sm">
            {leftLabel}
          </div>
        )}
      </div>
      ...
      >
        <div className="h-full w-[2px] -translate-x-1/2 bg-[rgba(251,248,243,0.92)] shadow-[0_0_12px_rgba(31,28,25,0.18)]" />

        <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2">
          <div
            className={[
              "flex h-12 w-12 items-center justify-center rounded-full border border-[rgba(31,28,25,0.14)]",
