    ...
    case "news":
      return (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
          <path d="M7 6h13v12a2 2 0 0 1-2 2H7" />
          <path d="M4 6h3v14H6a2 2 0 0 1-2-2V6Z" />
          <path d="M10 10h7" />
          <path d="M10 13h7" />
          <path d="M10 16h5" />
        </svg>
...
export const metadata: Metadata = {
  title: "CAR BOUTIQUE | 時代を超える価値を、整理する。",
  description:
    "時代を超える価値を、整理する。CAR BOUTIQUEは、NEWS・COLUMN・CARS・GUIDE・HERITAGEを横断して、クルマの背景と判断材料をまとめるメディア＆データベース。",
  openGraph: {
    title: "CAR BOUTIQUE | 時代を超える価値を、整理する。",
    description:
      "時代を超える価値を、整理する。CAR BOUTIQUEは、NEWS・COLUMN・CARS・GUIDE・HERITAGEを横断して、クルマの背景と判断材料をまとめるメディア＆データベース。",
...
export default async function HomePage() {
  const overviewShortcuts = [
    { href: "/news", label: "NEWS", desc: "新型車・モデルチェンジ", kind: "news" },
    ...
    { href: "/cars", label: "DATABASE", desc: "車種データベース", kind: "database" },
  ] as const;
