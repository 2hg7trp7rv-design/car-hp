...
export function CompareAddButton({
  ...
  return (
    <Button
      ...
      onClick={onClick}
      className={[
        "cb-tap h-11 w-11 rounded-full border bg-[rgba(251,248,243,0.94)]",
        isActive
          ? "border-[rgba(122,135,108,0.34)] text-[var(--accent-strong)]"
    ...
    >
      <CompareIcon className={justAdded ? "h-5 w-5 scale-[1.05]" : "h-5 w-5"} />
    </Button>
  );
}
