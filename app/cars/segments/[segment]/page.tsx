...
// セグメント意味説明 (B04)
const SEGMENT_DESC: Record<string, { meaning: string; priceRange: string; suitedFor: string }> = {
  "Kカー": {
    meaning: "排気量660cc以下、全長3.4m以下の日本独自の軽自動車規格。税金・保険料が安い。",
    priceRange: "新車80〜200万円 / 中古20〜150万円",
    suitedFor: "維持費を最小化したい人・街乗り中心・若い世代の1台目",
  },
  "コンパクト(Bセグ)": {
    meaning: "全長4m前後の小型乗用車。取り回しが良くファミリーカーとしても人気。",
    priceRange: "新車150〜280万円 / 中古40〜200万円",
    suitedFor: "街乗り中心・駐車スペースが限られる環境・コスパ重視",
  },
  "ミドルクラス(Cセグ)": {
    meaning: "全長4〜4.5m前後の中型乗用車。居住性と走行性能のバランスが良い主力クラス。",
    priceRange: "新車200〜400万円 / 中古60〜300万円",
    suitedFor: "ファミリー・通勤と週末両用・バランス重視の人",
  },
  "Dセグメント": {
    meaning: "全長4.5〜4.8m前後の上級セダン・ワゴン。高い走行性能と静粛性を持つ。",
    priceRange: "新車350〜700万円 / 中古80〜500万円",
    suitedFor: "ビジネス用途・長距離移動が多い人・品質重視",
  },
  "高級/Eセグ以上": {
    meaning: "フルサイズの高級乗用車。最高クラスの快適性・安全装備・ブランド性を持つ。",
    priceRange: "新車500万円〜 / 中古100万円〜",
    suitedFor: "最高水準の乗り心地を求める人・代表車・社用車",
  },
};
const segmentDesc = SEGMENT_DESC[label] ?? null;
  ...
  return (
    <main className="relative min-h-screen text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-32 pt-28 sm:px-6 lg:px-8">
        ...
        {/* パンくず */}
        <Breadcrumb items={[{ label: "HOME", href: "/" }, { label: "CARS", href: "/cars" }, { label: "SEGMENTS", href: "/cars/segments" }, { label }]} className="mb-6" />
            ...
            {segmentDesc && (
              <div className="mt-4 grid gap-3 sm:grid-cols-3">
                <div className="rounded-xl bg-white/60 p-3">
                  <p className="text-[10px] font-semibold tracking-[0.18em] text-[#222222]/55">セグメントの意味</p>
                  <p className="mt-1 text-[12px] leading-relaxed text-[#222222]/75">{segmentDesc.meaning}</p>
                </div>
                <div className="rounded-xl bg-white/60 p-3">
                  <p className="text-[10px] font-semibold tracking-[0.18em] text-[#222222]/55">価格帯の目安</p>
                  <p className="mt-1 text-[12px] leading-relaxed text-[#222222]/75">{segmentDesc.priceRange}</p>
                </div>
                <div className="rounded-xl bg-white/60 p-3">
                  <p className="text-[10px] font-semibold tracking-[0.18em] text-[#0ABAB5]">向く人</p>
                  <p className="mt-1 text-[12px] leading-relaxed text-[#222222]/75">{segmentDesc.suitedFor}</p>
                </div>
              </div>
            )}
