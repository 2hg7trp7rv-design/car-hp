...
const SUMMARY_ITEMS = [
  { label: "Scope", title: "適用", body: "当サイトおよび関連ページ" },
  { label: "Purpose", title: "主な用途", body: "アクセス解析 / お問い合わせ対応 / 不正防止" },
  { label: "Control", title: "設定変更", body: "Cookie設定はフッターから変更可能" },
] as const;
...
export default function PrivacyPolicyPage() {
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "プライバシーポリシー", item: `${getSiteUrl()}/legal/privacy` },
    ],
  };
  ...
  return (
    <>
      ...
      <LegalDocHeader
        ...
        lead="CAR BOUTIQUE JOURNALは、利用者の個人情報を適切に取り扱うため、以下の方針を定めます"
        meta={[]}
      />
      ...
      <div className="mt-8 space-y-8">
        ...
        <div className="space-y-10">
          <LegalDocSection index="01" title="適用範囲">
            <p>
              本プライバシーポリシーは、当サイト（<span className="break-all">{getSiteUrl()}</span>）および関連ページに適用されます
            </p>
          </LegalDocSection>
          ...
          <LegalDocSection index="03" title="アクセス解析ツールについて">
            ...
            <p>当サイトのアクセス解析の許可・拒否は、フッターのCookie設定からいつでも変更できます</p>
          </LegalDocSection>
          ...
          <LegalDocSection index="07" title="お問い合わせ窓口">
            <p>
              本ポリシーに関するお問い合わせは、<Link href="/contact">お問い合わせフォーム</Link>からご連絡ください
            </p>
          </LegalDocSection>
        </div>
        ...
        <LegalRelatedLinks
          items={[
            ...
            { href: "/legal/about", label: "運営者情報", description: "媒体の目的と運営姿勢の概要" },
            { href: "/contact", label: "お問い合わせ", description: "個人情報の取り扱いに関する連絡窓口" },
          ]}
        />
      </div>
    </>
