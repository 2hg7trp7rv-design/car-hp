...
export function HamburgerMenu() {
  ...
  const items: NavItem[] = useMemo(
    () => [
      { href: "/", label: "HOME", desc: "トップ" },
      { href: "/guide", label: "GUIDE", desc: "買う・維持する・売る" },
      { href: "/column", label: "COLUMN", desc: "整備・トラブル・考え方" },
      { href: "/heritage", label: "HERITAGE", desc: "文化と背景" },
      { href: "/cars", label: "CARS", desc: "車種データベース" },
      { href: "/search", label: "SEARCH", desc: "キーワード検索" },
    ],
    [],
  );
                ...
                {items.map((it, idx) => (
                  <li key={it.href} className="border-b border-[#222222]/10 pb-8">
                    ...
                    >
                      ...
                      {it.desc && (
                        <p className="mt-3 pl-[40px] text-[13px] leading-relaxed tracking-[0.04em] text-[#222222]/60">
                          {it.desc}
                        </p>
                      )}
                    </Link>
