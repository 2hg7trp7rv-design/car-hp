        ...
        >
          <summary className="cursor-pointer list-none text-[15px] font-semibold leading-[1.65] tracking-[-0.02em] text-[var(--text-primary)]">
            <span className="inline-flex items-start gap-3">
              <span className="mt-[2px] inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[rgba(122,135,108,0.18)] bg-[var(--accent-subtle)] text-[11px] font-semibold tracking-[0.12em] text-[var(--accent-strong)]">
                Q
              </span>
              <span>{item.q}</span>
            </span>
