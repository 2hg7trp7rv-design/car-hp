...
const affiliateEnv = (process.env.NEXT_PUBLIC_AFFILIATE_ENV || "").trim().toLowerCase();
...
if (affiliateEnv !== "prod") {
  fail(`NEXT_PUBLIC_AFFILIATE_ENV=prod is required in production (current: "${affiliateEnv || "(empty)"}")`);
}
