    ...
    <>
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-[12px] leading-relaxed text-[#222222]/65 sm:text-sm">
          CAR BOUTIQUE JOURNAL(以下「当サイト」)は、利用者の個人情報を適切に取り扱うため、以下の方針を定めます。
        </p>
      </header>

      <div className="mt-10 space-y-10">
        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          <h2 className="text-lg font-semibold text-[#222222]">1. 適用範囲</h2>
          <p>
            本プライバシーポリシーは、当サイト(
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          ...
          <p>
            当サイトのアクセス解析の許可・拒否は、フッターの「Cookie設定」からいつでも変更できます。
          </p>
        </section>

        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          <h2 className="text-lg font-semibold text-[#222222]">4. 第三者への提供</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          <h2 className="text-lg font-semibold text-[#222222]">5. 個人情報の管理</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          <h2 className="text-lg font-semibold text-[#222222]">6. 本ポリシーの変更</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          <h2 className="text-lg font-semibold text-[#222222]">7. お問い合わせ窓口</h2>
          <p>
            本ポリシーに関するお問い合わせは、
