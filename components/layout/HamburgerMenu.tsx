    ...
    <>
      <button
        ...
        className={cn(
          ...
          "transition-colors duration-300 hover:border-[rgba(122,135,108,0.30)]",
          open && "border-[rgba(122,135,108,0.40)] bg-[var(--surface-2)]",
        )}
      >
      ...
      >
        ...
        <div className="safe-area-top safe-area-bottom safe-area-left safe-area-right absolute inset-0 overflow-y-auto">
          <div className="mx-auto flex max-w-5xl flex-col px-4 pb-14 pt-20 sm:px-6 lg:px-8">
            <div className="rounded-[28px] border border-[var(--border-default)] bg-[rgba(251,248,243,0.98)] p-6 shadow-[0_28px_64px_rgba(31,28,25,0.16)] sm:p-8">
              <div className="flex items-start justify-between gap-8">
                ...
                <button
                  ...
                  onClick={() => setOpen(false)}
                  className={cn(
                    "cb-tap inline-flex items-center gap-3 rounded-full border border-[var(--border-default)] px-4 py-2 text-[11px] font-medium tracking-[0.18em] text-[var(--text-primary)] transition-colors duration-300 hover:bg-[var(--surface-2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(122,135,108,0.42)]",
                  )}
                >
                  CLOSE
                      ...
                      <li key={it.href}>
                        <Link
                          ...
                          className={cn(
                            ...
                            active
                              ? "border-[rgba(122,135,108,0.28)] bg-[var(--surface-moss)]"
                              : "border-[var(--border-default)] bg-[var(--surface-1)] hover:bg-[var(--surface-2)]",
                            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(122,135,108,0.42)]",
                          )}
                        >
