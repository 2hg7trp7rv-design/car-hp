...
const quality = {
  CAR: (car) => {
    ...
    return {
      ok: meetsLength && hasBullets && hasBudget && hasMaint,
      metrics: { contentLen, bodyLen, strengthsCount: strengths.length, concernsCount },
      checks: { meetsLength, hasBullets, hasBudget, hasMaint },
    };
  },
  GUIDE: (g) => {
