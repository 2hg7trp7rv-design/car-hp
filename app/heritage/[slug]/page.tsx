...
{/* TOC (Highlights は仕様変更で撤去) */}
      ...
      {relatedHeritage.length > 0 ? (
        <section className="page-shell pb-20">
          <div className="porcelain porcelain-panel overflow-hidden rounded-3xl border border-white/10 bg-white/92 p-6 shadow-soft-card">
            <div className="flex items-end justify-between gap-4">
              <div>
                <p className="text-[11px] tracking-[0.22em] text-[#222222]/55">NEXT STORY</p>
                <h2 className="serif-heading mt-2 text-[18px] text-[#222222]">次に読む</h2>
              </div>
              <Link href="/heritage" className="cb-tap inline-flex items-center text-[12px] text-[#0ABAB5] hover:underline">
                HERITAGE一覧
              </Link>
            </div>
