          ...
          <div className="mx-auto flex max-w-5xl flex-col px-4 pb-14 pt-20 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {[
                ...
                { href: "/site-map#tools", label: "TOOLS" },
              ].map((it) => (
                <Link
                  key={it.href}
                  href={it.href}
                  ...
                  className={cn(
                    "cb-tap inline-flex items-center rounded-full",
                    "border border-white/15 px-4 py-2",
                    "text-[11px] font-medium tracking-[0.18em] text-white/70",
                    "transition-colors duration-300 hover:border-[#0ABAB5]/60 hover:text-[#0ABAB5]",
                    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0ABAB5]/50",
                  )}
                >
                  {it.label}
