    ...
    <main className="relative min-h-screen text-white">
      ...
      <div className="page-shell pb-24 pt-24">
        ...
        <div className="mb-8">
          ...
          <h1 className="serif-heading mt-2 text-3xl text-[#222222]">比較の使い方HUB</h1>
          <p className="mt-3 max-w-2xl text-[13px] leading-relaxed text-[#222222]/65">
            売却は「相場」より先に、比較のやり方で損しやすいです。電話・条件・減額のズレを先に
            整えて、落ち着いて進められる形にします。
          </p>

          <div className="mt-4 flex flex-wrap gap-2 text-[12px] text-[#222222]/65">
            <span className="rounded-full border border-[#222222]/12 bg-white/70 px-3 py-1 text-[#222222]/80">
              連絡方法
            </span>
            <span className="rounded-full border border-[#222222]/12 bg-white/70 px-3 py-1 text-[#222222]/80">
              比較条件
        ...
        <GlassCard className="p-6 md:p-7">
          <Reveal>
            ...
            <h2 className="mt-2 text-[14px] font-semibold tracking-wide text-[#222222]/85">
              状況別分岐：まずはここから
            </h2>
            ...
            <div className="mt-6 rounded-2xl border border-[#222222]/12 bg-white/70 p-4 text-[12px] leading-relaxed text-[#222222]/80">
              <p className="font-semibold text-[#222222]/85">迷ったらこの順番</p>
              <ol className="mt-2 list-decimal pl-5">
                <li>条件を揃える（年式・走行・傷・修復など）</li>
                <li>相場を取る（同じ条件で）</li>
                <li>最後に決める（入金日・名義変更・キャンセル）</li>
              </ol>
              <p className="mt-3 text-[#222222]/65">
                もっと基礎から見たい場合は{" "}
        ...
        {/* 末尾ナビ — GUIDE一覧へ (B10) */}
        <div className="mt-10 border-t border-[#222222]/10 pt-8">
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/cars"
              className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/10 bg-white px-5 py-3 text-[12px] tracking-[0.18em] text-[#222222]/75 shadow-soft transition hover:border-[#0ABAB5]/35"
            >
              CARS — 車種を探す
            </Link>
          </div>
