  ...
  return (
    <>
      <header className={carArticle ? "cbj-car-header fixed inset-x-0 top-0 z-50" : "fixed inset-x-0 top-0 z-50"}>
        <div className={carArticle ? "cbj-car-header-surface" : "border-b border-[rgba(31,28,25,0.08)] bg-[rgba(246,242,235,0.86)] backdrop-blur-md"}>
          <div className={carArticle ? "cbj-car-header-inner page-shell flex items-center justify-between gap-4" : "page-shell flex h-[64px] items-center justify-between gap-4 lg:h-[72px]"}>
            <Link href="/" className={carArticle ? "cbj-car-header-logo group flex min-w-0 flex-col leading-none" : "group flex min-w-0 flex-col leading-none"}>
              <span
                className={carArticle ? "truncate transition-colors duration-150" : "truncate text-[11px] font-semibold tracking-[0.24em] transition-colors duration-150 text-[var(--text-primary)] group-hover:text-[var(--accent-base)] md:text-[12px]"}
            ...
            <button
              ...
              className={carArticle ? "cbj-car-menu-button inline-flex items-center justify-center transition-colors duration-150 lg:hidden" : "inline-flex h-10 w-10 items-center justify-center rounded-full border border-[var(--border-default)] bg-[rgba(251,248,243,0.92)] transition-colors duration-150 hover:bg-[var(--surface-2)] lg:hidden"}
            >
