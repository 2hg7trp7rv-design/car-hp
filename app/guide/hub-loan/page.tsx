...
export const metadata: Metadata = {
  title: "ローン・支払い方法ガイド｜月々の負担と条件を整理",
  description: "残クレ・リース・ローン。言葉の違いで迷う前に、まずは月々の目安と条件を見ます。",

  alternates: { canonical: `${getSiteUrl()}/guide/hub-loan` },
};
          ...
          <div className="lg:flex-1">
            <Reveal>
              <header className="mb-10">
                <h1 className="serif-heading mt-2 text-3xl text-[var(--text-primary)]">ローン・支払い方法ガイド</h1>
                <p className="mt-3 text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
                  残クレ・リース・ローンの違いと、月々の支払い目安を見る。
                </p>
              </header>
            </Reveal>
            ...
            <section id="entry" className="mb-12 scroll-mt-28">
              <Reveal>
                <h2 className="serif-heading text-xl text-[var(--text-primary)]">次の一手</h2>
                <p className="mt-2 text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
                  比較条件が固まったら、次は数字で現実を固定します。
                  先に上限を決めると、車選びでブレません。
                </p>
                <HubEntryShelf
