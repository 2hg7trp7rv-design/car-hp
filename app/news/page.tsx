          ...
          >
            <form className="space-y-4 text-xs sm:text-[11px]">
              ...
              <details className="group">
                <summary className="flex cursor-pointer list-none items-center gap-2 text-[10px] font-medium tracking-[0.22em] text-[#222222]/45 hover:text-[#222222]/70 transition-colors [&::-webkit-details-marker]:hidden">
                  <span className="transition-transform group-open:rotate-90">▶</span>
                  詳細フィルタ（メーカー / ソース / タグ / 期間）
                </summary>
