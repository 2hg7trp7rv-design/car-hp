...
const GUIDE_DISPLAY_TAG_IMAGE_POOLS: Record<SharedDisplayTag, string[]> = {
  ...
  "カスタム": [
    "/images/cbj/display-tags/guides/maintenance-1.jpg",
    "/images/cbj/article-system/content/aftermarket-air-cleaner-risk-guide/cover.webp",
  ],
  "吸気": [
    "/images/cbj/article-system/content/aftermarket-air-cleaner-risk-guide/cover.webp",
    "/images/cbj/article-system/content/aftermarket-air-cleaner-risk-guide/aftermarket-air-point-overview.webp",
  ],
  "足回り": [
    "/images/cbj/article-system/content/car-suspension-hard-soft-merit-demerit/cover.webp",
    "/images/cbj/article-system/content/electronic-damper-coilover-risk-guide/cover.webp",
    "/images/cbj/article-system/content/adas-lowered-car-aiming-risk-guide/cover.webp",
  ],
  "電装": [
    "/images/cbj/article-system/content/tv-canceller-can-risk-guide/cover.webp",
    "/images/cbj/article-system/content/tv-canceller-can-risk-guide/tv-canceller-network-overview.webp",
  ],
  "安全装置": [
    "/images/cbj/article-system/content/adas-lowered-car-aiming-risk-guide/cover.webp",
    "/images/cbj/article-system/content/adas-lowered-car-aiming-risk-guide/adas-sensor-role-overview.webp",
  ],
  "保険": [
...
const COLUMN_DISPLAY_TAG_IMAGE_POOLS: Record<SharedDisplayTag, string[]> = {
  ...
  "カスタム": [
    "/images/cbj/article-system/content/modern-car-custom-regret-reason-column/cover.webp",
    "/images/cbj/display-tags/columns/maintenance-1.jpg",
    "/images/cbj/article-system/content/aftermarket-air-cleaner-risk-guide/cover.webp",
  ],
  "吸気": [
...
export function resolveGuideCardImage(
  ...
  if (pool.length === 0) return articleTopImage;
  return pool[stableIndex(guide.slug || tag, pool.length)] ?? articleTopImage;
}
...
export function resolveColumnCardImage(
  ...
  if (pool.length === 0) return articleTopImage;
  return pool[stableIndex(column.slug || tag, pool.length)] ?? articleTopImage;
}
