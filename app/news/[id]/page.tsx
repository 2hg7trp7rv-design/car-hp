...
function NewsShelfLinkCard({
  ...
  return (
    <TrackedLink
      ...
      toId={toId}
      shelfId={shelfId}
      className="group block overflow-hidden rounded-[24px] border border-[var(--border-default)] bg-[rgba(251,248,243,0.9)] p-4 transition hover:-translate-y-[1px] hover:border-[rgba(122,135,108,0.28)] hover:bg-[rgba(251,248,243,0.98)]"
    >
    ...
    <main className="detail-page">
      ...
      <div className="detail-shell pb-24 pt-24 sm:pt-28">
        ...
        <section className="mt-8 grid gap-4 lg:grid-cols-[minmax(0,1.12fr)_360px]">
          <section className="detail-card-moss p-6 sm:p-8" aria-label="この記事の見どころ">
          ...
          <article className="space-y-8">
            {(news.excerpt || news.commentJa || tags.length > 0) ? (
              <section className="detail-card p-6 sm:p-8">
                ...
                {news.commentJa ? (
                  <div className={news.excerpt ? "mt-8 border-t border-[rgba(31,28,25,0.08)] pt-8" : ""}>
                ...
                {tags.length > 0 ? (
                  <div className={news.excerpt || news.commentJa ? "mt-8 border-t border-[rgba(31,28,25,0.08)] pt-8" : ""}>
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {tags.map((tag) => (
                        <Link
                          ...
                          rel="nofollow"
                          className="detail-chip detail-chip-clay"
                        >
                          #{tag}
                        </Link>
                      ))}
          ...
          <aside className="space-y-6" aria-label="関連導線">
            ...
            {(recommended.cars.length > 0 ||
              ...
              <ShelfImpression shelfId="news_recommendations" variant="recommendations">
                <section className="detail-card-slate p-6">
