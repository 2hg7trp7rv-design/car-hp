        ...
        <div className="flex flex-col gap-4 p-4 sm:flex-row sm:items-end sm:justify-between sm:gap-6 sm:p-5">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            ...
            <button
              type="button"
              onClick={accept}
              className="inline-flex min-h-[42px] items-center justify-center rounded-full border border-[rgba(14,124,123,0.24)] bg-[rgba(14,124,123,0.12)] px-4 text-[12px] font-semibold tracking-[0.08em] text-[var(--accent-strong)] transition hover:border-[rgba(14,124,123,0.34)] hover:bg-[rgba(14,124,123,0.18)]"
            >
              許可
            </button>
          </div>
