        ...
        {safeItems.map((it, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(31,28,25,0.30)] via-transparent to-transparent" />
              ...
              <div className="absolute inset-x-0 bottom-0 p-4 sm:p-6">
                <div className="max-w-[32rem] rounded-[22px] border border-[rgba(251,248,243,0.58)] bg-[rgba(251,248,243,0.88)] p-4 text-[var(--text-primary)] shadow-soft-card backdrop-blur-sm">
                  <p className="text-[10px] font-semibold tracking-[0.24em] text-[var(--accent-clay)] uppercase">
                    Pick
                  </p>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "border-[rgba(122,135,108,0.36)] bg-[var(--surface-moss)]"
                ...
                >
                  <span
                    className={cn(
                      ...
                      active ? "bg-[var(--accent-base)]" : "bg-[rgba(31,28,25,0.24)] group-hover:bg-[rgba(31,28,25,0.42)]",
                    )}
                  />
                </button>
              );
