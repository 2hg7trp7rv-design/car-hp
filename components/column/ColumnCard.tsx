    ...
    <Reveal delay={delay}>
      <Link href={href} className="block">
        <GlassCard
          ...
          padding="md"
          interactive
          className="porcelain group h-full border border-slate-200/80 bg-white/92 text-xs shadow-soft transition hover:-translate-y-[2px] hover:border-tiffany-200"
        >
          <div className="flex flex-col gap-3">
            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
              <div className="aspect-[16/9] w-full">
                <SeedPoster seedKey={column.slug} variant="column" />
              </div>
            </div>
