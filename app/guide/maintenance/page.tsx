...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${getSiteUrl()}/guide/maintenance` },
};
    ...
    <main className="relative min-h-screen bg-[var(--bg-stage)] text-[var(--text-primary)] pt-24 pb-20">
      ...
      <Reveal delay={80}>
        <header className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)] sm:text-[14px]">
            必要なものから順番に揃えるための基準を置いています。
          </p>
        </header>
      </Reveal>

      <StickyConclusionCard
        title="まず揃えるべきものと優先順位"
        bullets={[
        ...
        note="このハブは“買う順番”を固定して、無駄買いを減らすためのまとめページです。"
      />
      ...
      <section className="mt-10" aria-label="状況別分岐">
        <div className="mb-4">
          ...
          <p className="mt-2 max-w-2xl text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
            洗車・ドライブレコーダー・バッテリー対策など、目的別に見る。
          </p>
        </div>
