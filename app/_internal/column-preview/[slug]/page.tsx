          ...
          <div className="mx-auto max-w-4xl px-5 py-10">
                  <div className="mb-6">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2 text-[13px] text-[#222222]/80">
                      ...
                      <span className="rounded-full border border-[#222222]/10 bg-white px-3 py-1">headings: {hCount}</span>
                    ...
                    <div className="mt-3 rounded-2xl border border-[#222222]/10 bg-white/70 p-4 text-sm text-[#222222]/80">
                      <p className="font-semibold text-[#222222]">公開する時の最短チェック</p>
                      ...
                      <p className="mt-2 text-[13px] text-[#222222]/70">
                  ...
                  <div className="mt-6 text-xs text-[#222222]/55">
                    <p>
