...
export const metadata: Metadata = {
  title: "売却・乗り換えガイド｜準備から必要書類まで整理",
  description: "売り時・減額ポイント・書類。先に準備を整えてから動くと、損が減ります。",

  alternates: { canonical: `${getSiteUrl()}/guide/hub-sell` },
};
          ...
          <div className="lg:flex-1">
            <Reveal>
              <header className="mb-10">
                <h1 className="serif-heading mt-2 text-3xl text-[var(--text-primary)]">売却・乗り換えガイド</h1>
                <p className="mt-3 text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
                  売り時の判断・減額を防ぐポイント・必要書類など、売却前に確認したい情報を置いています。
                </p>
              </header>
            </Reveal>
            ...
            <section id="entry" className="mb-12 scroll-mt-28">
              <Reveal>
                ...
                <p className="mt-2 text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
                  準備と減額ポイントが整理できたら、次は相場を取って判断材料を揃えます。
