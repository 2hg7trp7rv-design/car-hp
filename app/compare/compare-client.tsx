      ...
      <section className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded-full border border-[rgba(27,63,229,0.24)] bg-[var(--surface-glow)] px-2.5 py-1 text-[10px] font-semibold text-[var(--accent-strong)]">
                  ...
                  >
                    {ENABLE_CAR_IMAGES ? (
                      hasHero ? (
                        ...
                        <div className="flex h-32 flex-col justify-between border-b border-[rgba(14,12,10,0.08)] bg-[linear-gradient(135deg,rgba(229,235,239,0.72),rgba(251,248,243,0.98))] p-4">
                          <div className="flex items-center justify-between gap-3 text-[10px] font-semibold tracking-[0.18em] text-[var(--accent-base)]">
                            <span>比較候補</span>
              ...
              <table className="min-w-[720px] w-full border-collapse text-[12px]">
                ...
                <tbody>
                  {rows.map((row, rowIndex) => (
                    ...
                    >
                      <td className="border-t border-[rgba(14,12,10,0.08)] px-4 py-3 align-top font-semibold text-[var(--text-primary)]">
                        {row.label}
                      </td>
                      {selectedCars.map((car) => (
                        <td
                          key={car.slug}
                          className="border-t border-[rgba(14,12,10,0.08)] px-4 py-3 align-top text-[var(--text-secondary)]"
                        >
