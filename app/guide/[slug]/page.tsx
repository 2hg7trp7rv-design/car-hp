...
export default async function GuideDetailPage({ params }: PageProps) {
  ...
  return (
    <main className="relative text-white">
      ...
      <DetailFixedBackground seed={params.slug} imageSrc={(guide.heroImage ?? (guide as any).ogImageUrl ?? null) as string | null} />
          ...
          <div className="space-y-14">
                  ...
                  return (
                    ...
                    >
                      <div className="cb-stage-chapter">
                        ...
                        <h2 className="cb-stage-chapterTitle">
                          {title}
                        </h2>
                      </div>
            ...
            {(guide.updateReason || (guide.sources && guide.sources.length > 0)) && (
              <div className="mt-12 space-y-6">
                {guide.updateReason ? (
                  <section className="overflow-hidden rounded-3xl border border-white/15 bg-black/20 p-6 backdrop-blur">
