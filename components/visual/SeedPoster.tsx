...
function pickVariantAccent(variant: Variant): { stroke: string; glow: string } {
  ...
  switch (variant) {
    case "car":
      return { stroke: "rgba(143,167,176,0.62)", glow: "rgba(143,167,176,0.12)" };
    case "guide":
      return { stroke: "rgba(143,167,176,0.55)", glow: "rgba(143,167,176,0.10)" };
    case "column":
      return { stroke: "rgba(143,167,176,0.50)", glow: "rgba(143,167,176,0.09)" };
    case "heritage":
      return { stroke: "rgba(143,167,176,0.58)", glow: "rgba(143,167,176,0.11)" };
    default:
      return { stroke: "rgba(143,167,176,0.52)", glow: "rgba(143,167,176,0.10)" };
  }
}
