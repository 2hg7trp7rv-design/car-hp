        ...
        <div
          className={cn(
            ...
            resolvedImage.hasRealImage
              ? "bg-[linear-gradient(180deg,rgba(251,248,243,0.02),rgba(31,28,25,0.18))]"
              : "bg-[linear-gradient(180deg,rgba(251,248,243,0.3),rgba(251,248,243,0.12),rgba(31,28,25,0.12))]",
          )}
        />
