    ...
    <article className="relative overflow-hidden py-16 sm:py-20 lg:py-24">
      ...
      >
        <div className="px-4 sm:px-6 lg:px-8">
          <span
            className={cn(
              "font-[var(--font-sans)] text-[clamp(5rem,16vw,11rem)] font-semibold leading-none tracking-[-0.05em] text-[rgba(76,69,61,0.18)]",
              isEven ? "pr-2" : "pl-2",
            )}
          >
            {sectionNo}
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="min-w-0 w-full lg:basis-[52%]">
            ...
            <h3 className="cb-sans-heading mt-5 max-w-[18ch] text-[clamp(1.45rem,3vw,2.5rem)] font-medium leading-[1.45] tracking-[-0.01em] text-[var(--text-primary)]">
            ...
            <div className="mt-8">
              ...
              >
                <span className="border-b border-[rgba(14,12,10,0.18)] pb-1 transition-colors duration-300 group-hover:border-[rgba(27,63,229,0.52)] group-hover:text-[var(--accent-strong)]">
                  記事へ
                </span>
                <span
                  aria-hidden="true"
