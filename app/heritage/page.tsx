...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  const description = "モデルの世代変遷と技術の歴史を、年代とテーマから読めます。";
...
export default async function HeritageArchivePage({ searchParams }: PageProps) {
  ...
  const decade = toSingle(resolvedSearchParams.decade);
  const displayTag = toSingle(resolvedSearchParams.displayTag);
    ...
    <main className="min-h-screen bg-[var(--paper)]">
      <JsonLd
        data={{
          ...
          "@type": "CollectionPage",
          name: "系譜",
          description: "モデルの世代変遷と技術の歴史を、年代とテーマから読めます。",
      ...
      <section className="relative flex min-h-[calc(100svh-64px)] flex-col overflow-hidden">
        ...
        <div className="page-shell relative z-10 flex flex-1 flex-col pb-16 pt-24 text-center">
          ...
          <div className="mt-auto">
            ...
            <h1 className="cb-category-hero-title cb-category-hero-title--wide">
              HERITAGE
            </h1>
