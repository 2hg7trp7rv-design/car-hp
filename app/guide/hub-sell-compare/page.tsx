      ...
      <div className="page-shell pb-24 pt-24">
        ...
        <div className="mb-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2 text-[12px] text-[rgba(76,69,61,0.82)]">
            <span className="rounded-full border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] px-3 py-1 text-[rgba(14,12,10,0.8)]">
              連絡方法
            </span>
            <span className="rounded-full border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] px-3 py-1 text-[rgba(14,12,10,0.8)]">
              比較条件
        ...
        <GlassCard className="p-6 md:p-7">
          <Reveal>
            ...
            <h2 className="mt-2 text-[14px] font-semibold tracking-wide text-[rgba(14,12,10,0.86)]">
              状況別ガイド
            </h2>
            ...
            <div className="mt-6 rounded-[20px] border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-4 text-[12px] leading-relaxed text-[rgba(14,12,10,0.8)]">
              <p className="font-semibold text-[rgba(14,12,10,0.86)]">迷ったときの順番</p>
