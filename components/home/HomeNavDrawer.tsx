...
type NavItemKey = "news" | "cars" | "column" | "guide" | "heritage";
...
/**
 * TOP専用ナビドロワー
 * 右上の丸ボタン→画面下にNEWS/CARS/COLUMN/GUIDE/HERITAGEカードを展開
          ...
          <div className="space-y-6 text-slate-700">
            ...
            <div>
              ...
              <p className="mt-1 text-[10px] tracking-[0.32em] text-slate-400">
                NEWS・COLUMNS・GUIDE・CARS・HERITAGE
              </p>
              <p className="mt-2 text-[10px] leading-relaxed text-slate-500">
                どこから見始めれば良いか迷ったときに
                NEWS/CARS/COLUMN/GUIDE/HERITAGEの入口だけまとめたナビです。
              </p>
            </div>
