...
export function proxy(req: NextRequest) {
  ...
  const isProd =
    ...
    (String(process.env.VERCEL_ENV || "") === "" && String(process.env.NODE_ENV || "").toLowerCase() === "production");

  if (isProd && (url.pathname.startsWith("/_internal") || url.pathname === "/article-system-preview")) {
