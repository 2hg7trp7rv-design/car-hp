                ...
                <div className="relative aspect-[4/3] w-full">
                  ...
                  <>
                    <Image
                      ...
                      priority
                    />
                    {/* overlay: name + key details */}
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-slate-950/15 to-transparent" />
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                      <p className="serif-heading text-[16px] font-medium leading-snug text-white drop-shadow sm:text-[18px]">
                        {title}
                      </p>
                      <div className="mt-2 flex flex-wrap gap-2 text-[10px] text-white/90">
                        {car.segment ? (
