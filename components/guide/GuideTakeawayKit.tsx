...
function buildSellKit(_title: string): KitBlock[] {
      ...
      <Reveal>
        <GlassCard className="p-6 md:p-7">
          <div className="flex items-baseline justify-between gap-3">
            <h2 className="text-[14px] font-semibold tracking-wide text-[var(--text-secondary)]">
              持ち帰り（テンプレ）
            </h2>
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            {blocks.map((b, i) => {
              ...
              return (
                <div
                  key={key}
                  className="rounded-[20px] border border-[var(--border-default)] bg-[var(--surface-1)] p-4"
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-xl border border-[var(--border-default)] bg-[var(--surface-1)] px-3 py-2 text-[12px] text-[var(--text-secondary)] hover:bg-[var(--surface-1)]"
                      aria-label="コピー"
                    >
                  ...
                  <pre className="mt-3 whitespace-pre-wrap rounded-xl bg-[rgba(228,219,207,0.45)] p-3 text-[12px] leading-relaxed text-[var(--text-secondary)]">
                    {b.content}
                  </pre>
                </div>
              );
