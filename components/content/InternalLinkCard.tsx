...
function worldAccent(kind: InternalLinkKind): string {
  switch (kind) {
    ...
    case "CARS":
      return "border-l-[#42A5F5] bg-white hover:border-[#42A5F5]/45";
    case "HERITAGE":
      return "border-l-[#FFB300] bg-white hover:border-[#FFB300]/45";
    default:
...
function worldBadge(kind: InternalLinkKind): string {
  switch (kind) {
    ...
    case "CARS":
      return "bg-[#EEF7FF] text-[#2687D9]";
    case "HERITAGE":
      return "bg-[#FFF8E1] text-[#C98500]";
    default:
