...
type ComparePageParams = Record<string, string | string[] | undefined>;

export default async function ComparePage({
  searchParams,
}: {
  searchParams?: Promise<ComparePageParams>;
}) {
    ...
    <main className="relative min-h-screen">
      ...
      <div className="page-shell pb-24 pt-24 space-y-10">
        <ArchivePageHero
          ...
          align="imageLeft"
          stats={[
            { label: "上限", value: "最大3台", tone: "moss" },
            { label: "比較軸", value: "価格 / 弱点 / 傾向", tone: "slate" },
            { label: "比較", value: "同じ面で見比べる", tone: "clay" },
          ]}
          links={[
            ...
            <section className="cb-panel p-5 sm:p-6">
              ...
              <div className="mt-5 grid gap-3">
                ...
                <Link
                  ...
                  className="rounded-[20px] border border-[var(--border-default)] bg-[rgba(251,248,243,0.72)] px-4 py-4 transition-colors duration-150 hover:bg-[var(--surface-2)]"
                >
                  <div className="text-[15px] font-medium text-[var(--text-primary)]">車種一覧</div>
                  <div className="mt-1 text-[12px] leading-[1.75] text-[var(--text-tertiary)]">
                    候補を一覧で見直す
                  </div>
                </Link>
