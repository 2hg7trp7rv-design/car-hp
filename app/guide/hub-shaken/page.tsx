...
export const metadata: Metadata = {
  title: "車検｜費用と流れを理解して、無駄を減らす",
  description:
    "車検の費用・内訳・当日の流れ・落ちやすいポイントを整理。相場を把握してから予約へ進むためのガイド。",
          ...
          <div className="lg:flex-1">
            <Reveal>
              <header className="mb-10">
                <p className="text-[10px] font-semibold tracking-[0.3em] text-[var(--accent-base)]">
                  
                </p>
                <h1 className="cb-sans-heading mt-2 text-3xl text-[var(--text-primary)]">車検</h1>
            ...
            <section className="mb-12">
              <Reveal>
                <FaqList
                  theme="light"
                  title="車検のよくある質問"
                  description="予約前に、よくある不安を見ます。"
                  items={[
                    {
                      q: "車検はいつから受けられる？",
                      a: "一般に『満了日の2ヶ月前』から受検（地域・制度変更等で扱いが異なる場合があります）。余裕を持って早めに段取りするのが安全です。",
                    },
                    {
                      q: "落ちやすいポイントは？",
