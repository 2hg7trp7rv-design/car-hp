...
export default async function SiteMapPage() {
  ...
  { href: "/column", label: "考察", description: "業界・選び方・オピニオン" },
    ...
    <main className="relative min-h-screen bg-[var(--bg-stage)] text-[var(--text-primary)]">
      ...
      <div className="page-shell pb-24 pt-24">
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <Reveal delay={40}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">主要カテゴリ</h2>
              <ul className="mt-4 space-y-3 text-[12px] text-[rgba(14,12,10,0.8)]">
                {coreLinks.map((link) => (
          ...
          <Reveal delay={80}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">ガイド</h2>
              <ul className="mt-4 grid gap-2 text-[12px] text-[rgba(14,12,10,0.8)] sm:grid-cols-2">
                {guideHubs.map((link) => (
                  <li key={link.href}>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-3">
          <Reveal delay={120}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">メーカー別</h2>
              <ul className="mt-4 space-y-2 text-[12px] text-[rgba(14,12,10,0.8)]">
          ...
          <Reveal delay={160}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">ボディタイプ別</h2>
              <ul className="mt-4 space-y-2 text-[12px] text-[rgba(14,12,10,0.8)]">
          ...
          <Reveal delay={200}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">セグメント別</h2>
              <ul className="mt-4 space-y-2 text-[12px] text-[rgba(14,12,10,0.8)]">
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-3">
          <Reveal delay={240}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">最新ガイド</h2>
              <ul className="mt-4 space-y-2 text-[12px] text-[rgba(14,12,10,0.8)]">
          ...
          <Reveal delay={280}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">最新視点</h2>
              <ul className="mt-4 space-y-2 text-[12px] text-[rgba(14,12,10,0.8)]">
          ...
          <Reveal delay={320}>
            <div className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-6">
              <h2 className="font-sans text-[15px] font-semibold text-[var(--text-primary)]">最新の系譜</h2>
              <ul className="mt-4 space-y-2 text-[12px] text-[rgba(14,12,10,0.8)]">
