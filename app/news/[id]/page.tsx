        ...
        <div className="mx-auto grid max-w-5xl gap-6 px-4 py-8 md:grid-cols-[minmax(0,2fr)_minmax(0,1.1fr)] md:py-10">
          ...
          <div className="space-y-6">
                ...
                {news.url && (
                  <section className="border-t border-[#222222]/08 pt-4 text-xs">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-black/80 px-3 py-1.5 text-[11px] font-medium text-white/85 underline-offset-4 hover:bg-black/70"
                    >
                      元記事を開く
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {tags.map((tag) => (
                        <Link
                          ...
                          rel="nofollow"
                          className="rounded-full border border-[#222222]/16 bg-[#222222]/03 px-2.5 py-0.5 text-[11px] text-[#222222]/80 hover:border-tiffany-400 hover:bg-white"
                        >
                          #{tag}
                        </Link>
                      ))}
            ...
            <div className="flex justify-start pt-2">
              <Link
                href="/news"
                className="inline-flex items-center gap-2 text-xs font-medium text-[#222222]/70 underline-offset-4 hover:text-[#222222] hover:underline"
              >
                        ...
                        <div className="space-y-2">
                          {recommended.cars.map((car) => (
                            <TrackedLink
                              ...
                              toId={car.slug}
                              shelfId="news_recommendations"
                              className="block rounded-lg border border-[#222222]/10 bg-white/70 p-3 text-xs text-[#222222]/85 transition hover:border-tiffany-300 hover:bg-white"
                            >
