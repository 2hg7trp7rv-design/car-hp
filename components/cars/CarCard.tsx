...
export function CarCard({ car, delay = 0 }: Props) {
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-start justify-between gap-2">
                ...
                {car.difficulty && (
                  <div className="shrink-0 rounded-full border border-slate-200 bg-slate-50 px-2 py-1 text-[10px] tracking-[0.14em] text-slate-600">
                    {car.difficulty}
                  </div>
                )}
              </div>
