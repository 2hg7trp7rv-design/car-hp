...
const ALLOWED_VARIANTS = new Set([
  ...
  // Shared article toybox aliases accepted by components/articleDesignSystem/article-toybox.ts.
  "defaultCard", "softCard", "outlineCard", "emphasisCard", "compactCard",
  "leadText", "paragraphLead", "sectionTitle", "sectionHeading",
  "summaryCard", "cbjSummaryCard", "toySummaryCard",
  "infoBox", "cbjInfoBox", "toyInfoBox",
  "systemCards", "cbjSystemCards", "toySystemCards",
  "dataTable", "cbjDataTable", "toyDataTable",
  "checklistCard", "cbjChecklistCard", "toyChecklistCard",
  "numberedSteps", "cbjNumberedSteps", "toyNumberedSteps",
  "stepCards", "cbjStepCards", "toyStepCards",
  "default-card", "soft-card", "outline-card", "emphasis-card", "compact-card",
  "lead-text", "paragraph-lead", "section-title", "section-heading",
  "summary-card", "cbj-summary-card", "toy-summary-card",
  "info-box", "cbj-info-box", "toy-info-box",
  "system-cards", "cbj-system-cards", "toy-system-cards",
  "data-table", "cbj-data-table", "toy-data-table",
  "checklist-card", "cbj-checklist-card", "toy-checklist-card",
  "numbered-steps", "cbj-numbered-steps", "toy-numbered-steps",
  "step-cards", "cbj-step-cards", "toy-step-cards",
]);
