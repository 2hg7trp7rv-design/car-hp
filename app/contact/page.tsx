    ...
    <main className="relative min-h-screen">
      ...
      <div className="page-shell pb-24 pt-24 space-y-10">
        <ArchivePageHero
          ...
          align="imageLeft"
          stats={[
            { label: "用途", value: "ご意見 / 修正依頼 / 相談", tone: "moss" },
            { label: "返信", value: "必要時のみメールで", tone: "slate" },
            { label: "参考", value: "URL添付で確認しやすく", tone: "clay" },
          ]}
          links={[
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)]">
          ...
          <section className="cb-panel p-5 sm:p-6 lg:p-8">
            ...
            <form action={FORM_ENDPOINT} method="POST" className="space-y-5">
              ...
              <div className="rounded-[22px] border border-[rgba(192,124,89,0.18)] bg-[var(--surface-clay)] px-4 py-4 text-[12px] leading-[1.8] text-[var(--text-secondary)]">
                個人情報の取り扱いは
