...
export default async function CarsMakersIndexPage() {
  ...
  return (
    <main className="relative min-h-screen text-white">
      <DetailFixedBackground imageSrc="/images/exhibit/kv-makers.webp" noUpscale />
      ...
      <div className="mx-auto max-w-7xl px-4 pb-32 pt-28 sm:px-6 lg:px-8">
        ...
        {/* パンくず */}
        <Breadcrumb items={[{ label: "HOME", href: "/" }, { label: "CARS", href: "/cars" }, { label: "MAKERS" }]} className="mb-6" />
          ...
          <Reveal delay={80}>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div className="text-[10px] text-[#222222]/55">
                ...
                <p className="mt-2 text-right text-2xl font-semibold text-[#222222]">
                  {makers.length}
                </p>
              </div>
            </div>
        ...
        <section aria-label="メーカー一覧">
          <div className="mb-4 flex items-baseline justify-between gap-2">
            <h2 className="text-xs font-semibold tracking-[0.22em] text-[#222222]/70">
              MAKER LIST
            </h2>
            <p className="text-[10px] text-[#222222]/55">
              クリックでモデル一覧へ
            </p>
          </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-[10px] text-[#222222]/55">
                        モデル: <span className="font-semibold text-[#222222]/80">{m.count}</span>
                      </p>
                    </div>
                  ...
                  {topModels.length > 0 && (
                    <div className="mt-3 border-t border-[#222222]/10 pt-3 text-[10px] text-[#222222]/55">
                      <p className="font-medium tracking-[0.2em] text-[#222222]/55">
                        RECENT MODELS
                      </p>
