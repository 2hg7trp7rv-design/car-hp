      ...
      <div className="page-shell pb-24 pt-24">
        <div className="mx-auto max-w-4xl rounded-[20px] border border-[var(--border-default)] bg-[var(--surface-1)] p-6 shadow-soft-card sm:p-8">
          ...
          <header className="max-w-2xl">
            ...
            <h1 className="serif-heading mt-4 text-[30px] leading-[1.22] text-[var(--text-primary)] sm:text-[36px]">
              主要カテゴリの一覧です。
            </h1>
          ...
          <section aria-label="主要カテゴリ" className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {rooms.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="rounded-[18px] border border-[var(--border-default)] bg-[var(--surface-2)] p-5 transition-colors duration-150 hover:border-[rgba(122,135,108,0.3)] hover:bg-[rgba(228,219,207,0.58)]"
              >
