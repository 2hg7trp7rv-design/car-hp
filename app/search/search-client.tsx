            ...
            {filterButtons.map((b) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-2 text-[10px] font-semibold tracking-[0.18em] transition ${
                    active
                ...
                >
                  {b.label}
                  {!loading && results && b.key !== "all" && (
                    <span className={`rounded-full px-1.5 py-0.5 text-[9px] font-medium ${
                      active ? "bg-white/25 text-white" : "bg-[#222222]/8 text-[#222222]/55"
                    }`}>
                      {results.filter(r => r.type === b.key).length}
                    </span>
                  )}
                  {!loading && results && b.key === "all" && (
                    <span className={`rounded-full px-1.5 py-0.5 text-[9px] font-medium ${
