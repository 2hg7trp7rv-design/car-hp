...
const nextConfig = {
  ...
  // Output File Tracing で content 配下（Markdown本文）を確実に含める
  // - Vercel の serverless / standalone で fs 読み込みが必要になった場合に備える
  // - Next 14 は experimental にぶら下がる
  experimental: {
    outputFileTracingIncludes: {
      "/*": ["./content/cars/**/*", "./content/guides/**/*", "./content/columns/**/*", "./content/heritage/**/*"],
    },
