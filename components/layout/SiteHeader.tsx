        ...
        <div className="flex items-center sm:hidden">
          <Link href="/start">
            <Button
              ...
              size="sm"
              magnetic
              className="border-tiffany-500/30 bg-white/45 text-[10px] font-semibold tracking-[0.18em] text-slate-900 shadow-soft-glow backdrop-blur-lg hover:bg-white/80"
            >
              START
            </Button>
          </Link>
          ...
          <Link href="/search" className="ml-2">
            <Button
              ...
              size="icon"
              magnetic
              className="border-tiffany-500/30 bg-white/45 text-slate-900 shadow-soft-glow backdrop-blur-lg hover:bg-white/80"
              aria-label="SEARCH"
            >
              <SearchIcon className="h-4 w-4" />
            </Button>
          ...
          <Link href={compareUrl} className="ml-2">
            <Button
              ...
              size="icon"
              magnetic
              className="relative border-tiffany-500/30 bg-white/45 text-slate-900 shadow-soft-glow backdrop-blur-lg hover:bg-white/80"
              aria-label="COMPARE"
            >
              <CompareIcon className="h-4 w-4" />
              {compareCount > 0 && (
