  ...
  return (
    <>
      ...
      <div className="mt-12 space-y-12">
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              {group.items.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="rounded-[24px] border border-[var(--border-default)] bg-[rgba(251,248,243,0.82)] px-5 py-5 transition-colors duration-150 hover:border-[rgba(27,63,229,0.28)] hover:bg-[var(--surface-2)]"
                >
        ...
        <section className="rounded-[24px] border border-[rgba(27,63,229,0.18)] bg-[var(--surface-glow)] px-5 py-5 sm:px-6">
