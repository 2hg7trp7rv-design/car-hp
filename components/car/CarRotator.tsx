...
export function CarRotator({
  ...
  return (
    ...
    >
      {totalFrames > 1 && (
        <div className="absolute left-4 top-4 z-20 flex items-center gap-2 rounded-full border border-[rgba(27,63,229,0.24)] bg-[rgba(251,248,243,0.92)] px-3 py-1.5 text-[10px] font-semibold tracking-[0.18em] text-[var(--text-primary)] shadow-sm backdrop-blur-sm">
      ...
      {!isAllLoaded && (
        ...
        >
          ...
          <div className="h-[3px] w-32 overflow-hidden rounded-full bg-[rgba(14,12,10,0.08)]">
            <div
      ...
      {isAllLoaded && !hasInteracted && !autoRotate && totalFrames > 1 && !reducedMotion && (
        <div className="pointer-events-none absolute inset-x-0 bottom-5 z-20 flex justify-center px-4">
          <div className="rounded-full border border-[rgba(14,12,10,0.10)] bg-[rgba(251,248,243,0.88)] px-4 py-2 text-[10px] font-semibold tracking-[0.16em] text-[var(--text-secondary)] backdrop-blur-sm">
            左右にドラッグして見る
          </div>
        </div>
      )}
