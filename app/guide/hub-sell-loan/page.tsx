...
export default async function HubPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 pb-16 pt-10 md:px-6">
      ...
      <div className="mb-6">
        <p className="text-[12px] tracking-wide text-slate-400">GUIDE HUB</p>
      ...
      <GlassCard className="p-6 md:p-7">
        <Reveal>
            ...
            <HubEntryShelf
              ...
              note={
                <p className="text-[11px] leading-relaxed text-slate-500">
                  “売却の全体像”は{" "}
                  <Link className="underline hover:text-slate-200" href="/guide/hub-sell">
                    こちら
                  </Link>
                  。比較の入口は{" "}
                  <Link
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4 text-[12px] leading-relaxed text-slate-300">
            <p className="font-semibold text-slate-200">最低限の確認（3つ）</p>
