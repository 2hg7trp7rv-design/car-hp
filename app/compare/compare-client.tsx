        ...
        {selectedCars.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-[#222222]/12 bg-white/70 p-5 text-[12px] text-[#222222]/65">
            ...
            <div className="mt-2 text-[11px] text-[#222222]/55">
              CARS で候補を探し、各車種ページの「比較」ボタンで追加してください。
            </div>
            <div className="mt-3 flex flex-wrap gap-2">
              <Link
                href="/cars"
                className="cb-tap inline-flex items-center rounded-full bg-[#0ABAB5] px-4 py-2 text-[11px] font-semibold text-[#042624] shadow-soft hover:opacity-90"
              >
                CARS一覧から探す
              </Link>
              <Link
