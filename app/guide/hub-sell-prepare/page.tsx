...
export const metadata: Metadata = {
  title: "査定準備｜減額を避けるためのチェックポイント",
  description:
    "売却で損しがちなポイントは、査定前の準備でほぼ決まります。最低限の段取りを短くまとめました。",

  alternates: { canonical: `${getSiteUrl()}/guide/hub-sell-prepare` },
};
      ...
      <div className="container mx-auto px-4 md:max-w-4xl">
        ...
        <Reveal>
          <header className="mb-10">
            <p className="text-[10px] font-semibold tracking-[0.3em] text-[var(--accent-slate)]"></p>
            <h1 className="serif-heading mt-2 text-3xl text-[var(--text-primary)]">査定準備</h1>
        ...
        <StickyConclusionCard
          ...
          note="売却準備で詰まりやすいポイントを整理するページです。"
        />

        {/* 1) 最初にやること（主要CTAは1つに絞る） */}
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="serif-heading text-xl text-[var(--text-primary)]">準備チェック</h2>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(31,28,25,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-slate)]">確認</p>
                <h3 className="mt-2 text-sm font-semibold">減額されやすいポイント</h3>
                <ul className="mt-3 space-y-2 text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
              ...
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(31,28,25,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-slate)]">方針</p>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="serif-heading text-xl text-[var(--text-primary)]">次に読む</h2>
            <p className="mt-2 text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] px-4 py-2 text-[11px] font-semibold tracking-[0.18em] text-[rgba(31,28,25,0.8)] hover:border-[rgba(122,135,108,0.3)] hover:text-[var(--accent-strong)]"
              >
                相場の目安へ
              </Link>
              <Link
