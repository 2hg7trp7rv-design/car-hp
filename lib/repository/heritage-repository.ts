...
function normalizeHeritage(raw: RawHeritageRecord, index: number): HeritageItem {
  ...
  // Prefer Markdown file body when exists: content/heritage/<slug>.md
  const bodyFromFile = HERITAGE_BODY_BY_SLUG.get(slug) ?? null;
 ...
 */
const RAW_ALL = readJsonDir("data/articles/heritage");
