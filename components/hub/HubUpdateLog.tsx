...
export function HubUpdateLog({ hubId, className }: Props) {
  ...
  return (
    <section
      className={cn(
        "mt-10 rounded-[20px] border border-[rgba(31,28,25,0.12)] bg-[rgba(228,219,207,0.42)] px-6 py-6 shadow-sm backdrop-blur",
        className,
      )}
    >
      <h2 className="serif-heading text-xl tracking-tight text-[var(--text-primary)]">更新ログ</h2>
