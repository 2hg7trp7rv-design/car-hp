  ...
  return (
    <main className="relative min-h-screen bg-[var(--bg-stage)] text-[var(--text-primary)]">
      ...
      <div className="page-shell pb-24 pt-24">
        <StatusPanel
          kicker="404 / コラム"
          title="このコラムは見つかりませんでした"
          lead="URLが間違っているか、コラムが統合された可能性があります。コラム一覧から辿り直してください。"
          variant="column"
          seedKey="not-found:column"
          note="迷ったら、コラム一覧か検索から入り直してください。"
        >
          <Link
            href="/column"
