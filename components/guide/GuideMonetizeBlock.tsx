    ...
    <Reveal delay={80}>
      ...
      >
        <GlassCard
          padding="lg"
          magnetic={false}
          className="border border-[rgba(14,12,10,0.12)] bg-[rgba(228,219,207,0.42)] shadow-soft-card"
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="space-y-2.5 md:max-w-[70%]">
              ...
              <h2 className="font-sans text-[15px] font-semibold tracking-tight text-[var(--text-primary)] sm:text-[16px]">
                {config.heading}
              </h2>
