...
export function CompareFloatingBar() {
  ...
  return (
    ...
    >
      <div className="porcelain flex items-center justify-between gap-3 rounded-full border border-[rgba(31,28,25,0.12)] bg-[rgba(251,248,243,0.92)] px-3 py-2 shadow-soft-card backdrop-blur">
