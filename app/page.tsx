...
export default async function Home() {
  ...
  return (
    <main className="bg-site text-text-main">
      {/*
        Intro splash
        - 要望: トップページのヒーロー画像が最初にふわっと全面表示 → その後に通常トップを表示
        - JSなし / 低負荷: CSSアニメーションでフェードアウト
      */}
      <div className="home-splash" aria-hidden="true">
        <picture>
          <source media="(min-width: 768px)" srcSet="/images/hero-top-desktop.jpeg" />
          <img
            src="/images/hero-top-mobile.jpeg"
            alt=""
            className="home-splash__img"
            loading="eager"
          />
        </picture>
        <div className="home-splash__veil" />
      </div>
