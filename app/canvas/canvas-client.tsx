        ...
        <GlassCard padding="md" className="bg-[var(--surface-1)]" magnetic={false}>
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <h2 className="mt-2 font-sans text-[18px] font-semibold tracking-tight text-[var(--text-primary)]">
                条件
              </h2>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 line-clamp-2 font-sans text-[18px] font-semibold tracking-tight text-[var(--text-primary)]">
                  {car.name}
                </h3>
              </div>
            ...
            {item.badges.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {item.badges.map((b) => (
                  <span
                    key={b}
                    className="rounded-full border border-[var(--border-default)] bg-[rgba(27,63,229,0.1)] px-3 py-1 text-[10px] font-semibold tracking-[0.14em] text-[var(--accent-strong)]"
                  >
                    {b}
                  </span>
                ))}
