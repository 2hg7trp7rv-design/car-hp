    ...
    <>
      ...
      {open && (
        <button
          ...
          aria-hidden="true"
          onClick={close}
          className="fixed inset-0 z-[45] bg-[rgba(31,28,25,0.16)] backdrop-blur-[1px]"
        />
      )}
      ...
      >
        ...
        >
          <div className="space-y-6 text-[var(--text-secondary)]">
            <div>
              <p className="serif-heading text-lg font-medium tracking-[0.12em] text-[var(--text-primary)]">
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      active
                        ? "border-[rgba(122,135,108,0.28)] bg-[var(--surface-moss)] text-[var(--text-primary)]"
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        active
                          ? "border-[rgba(122,135,108,0.28)] bg-[rgba(228,235,224,0.85)] text-[var(--accent-strong)]"
