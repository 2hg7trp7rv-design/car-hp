          ...
          <div className="lg:flex-1">
            <Reveal delay={80}>
              <header className="mb-8">
                <h1 className="cb-sans-heading mt-3 text-2xl text-[var(--text-primary)] sm:text-3xl">
                  自動車保険の選び方・見直しガイド
                </h1>
            ...
            <section id="entry" className="mt-12 scroll-mt-24">
              <Reveal delay={160}>
                <h2 className="cb-sans-heading text-xl text-[var(--text-primary)]">見積もりを始める</h2>
              ...
              <section className="mt-12">
                <div className="mb-4 flex flex-wrap items-baseline justify-between gap-3">
                  <div>
                    ...
                    <h2 className="cb-sans-heading mt-2 text-lg text-[var(--text-primary)] sm:text-xl">
                      さらに読む（必要なときだけ）
                    </h2>
                  </div>
                  <Link
                  ...
                  {picks.map((guide, index) => (
                    <Reveal key={guide.id} delay={260 + index * 40}>
                      <Link href={`/guide/${encodeURIComponent(guide.slug)}`}>
                        <GlassCard className="group h-full border border-[var(--border-default)] bg-[var(--surface-2)] p-4 text-xs shadow-soft transition hover:-translate-y-[1px] hover:border-[rgba(27,63,229,0.32)] hover:shadow-soft-card sm:p-5">
                          <h3 className="line-clamp-2 text-[13px] font-semibold leading-relaxed text-[var(--text-primary)] group-hover:text-[var(--accent-base)]">
                            {guide.title}
                          </h3>
                          {guide.summary && (
