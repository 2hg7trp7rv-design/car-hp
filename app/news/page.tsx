      ...
      <div className="page-shell pb-24 pt-24">
        ...
        <div className="mt-6">
          <ArchivePageHero
            ...
            stats={[
              { label: "掲載本数", value: `${news.length}本`, tone: "moss" },
              { label: "今回の表示", value: `${filtered.length}本`, tone: "clay" },
              { label: "直近7日", value: `${recentCount}本`, tone: "slate" },
            ]}
            links={[
        ...
        <section className="mt-12 grid gap-4 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          ...
          <div className="cb-panel p-5 sm:p-6">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <div className="rounded-[20px] border border-[rgba(122,135,108,0.18)] bg-[var(--surface-moss)] px-4 py-4">
              ...
              <div className="rounded-[20px] border border-[rgba(135,152,166,0.18)] bg-[var(--surface-slate)] px-4 py-4">
                <div className="text-[10px] font-semibold tracking-[0.18em] text-[var(--text-tertiary)]">
                  適用中の条件
                </div>
                <div className="mt-2 text-[20px] font-semibold leading-none text-[var(--accent-slate)]">
        ...
        {activeFilters.length > 0 ? (
          <div className="mt-6 flex flex-wrap items-center gap-2">
            {activeFilters.map((item) => (
              <span
                key={item}
                className="rounded-full border border-[rgba(31,28,25,0.08)] bg-[rgba(251,248,243,0.92)] px-3 py-1 text-[11px] text-[var(--text-secondary)]"
              >
                {item}
              </span>
            ))}
