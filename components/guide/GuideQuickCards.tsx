...
function renderBullet(text: string): ReactNode {
  ...
  if (m) {
    ...
    return (
      <Link
        href={href}
        className="underline decoration-[rgba(27,63,229,0.45)] underline-offset-2 hover:text-[var(--accent-strong)]"
      >
        {label}
      </Link>
    );
  ...
  return (
    ...
    >
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-4 overflow-hidden rounded-[20px] border border-[rgba(14,12,10,0.12)] bg-[rgba(251,248,243,0.6)]">
          <div className="grid sm:grid-cols-3">
            {resolved.map((card, idx) => (
              <div
                ...
                className={[
                  "p-4",
                  idx !== 0 ? "border-t border-[rgba(14,12,10,0.12)] sm:border-l sm:border-t-0" : "",
                ]
                  .filter(Boolean)
                  .join(" ")}
              >
                  ...
                  return (
                    <h3 className="text-[12px] font-semibold tracking-[0.12em] text-[var(--text-primary)]">
                      {card.id ? (
                        <a
                          href={`#${card.id}`}
                          className="underline decoration-transparent underline-offset-4 hover:decoration-[rgba(27,63,229,0.45)]"
                        >
                          {Title}
                        </a>
                      ) : (
