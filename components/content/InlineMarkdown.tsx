      ...
      {tokens.map((t, idx) => {
        ...
        return (
          <a
            ...
            className="underline decoration-[rgba(27,63,229,0.42)] underline-offset-4 transition-colors duration-120 hover:text-[var(--accent-strong)] hover:decoration-[var(--accent-base)]"
          >
            {label}
          </a>
        );
