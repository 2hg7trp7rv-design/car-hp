...
import { GuideQuickCards } from "@/components/guide/GuideQuickCards";
        ...
        <header className="mb-12 lg:mb-14">
          ...
          <Reveal delay={260}>
            <div className="mt-6 max-w-4xl">
              <GuideQuickCards categoryKey={getGuideCategoryKey(guide)} />
            </div>
          </Reveal>
        </header>
              ...
              <article className="relative z-10">
                ...
                {stepHeadings.length > 0 && (
                  <section className="mb-6 rounded-2xl border border-tiffany-100 bg-gradient-to-br from-tiffany-50/90 via-white to-white px-4 py-4 text-[11px] shadow-soft-card sm:px-5 sm:py-5">
                    <p className="mb-3 text-[11px] font-semibold tracking-[0.22em] text-tiffany-700">
                      GUIDE STEPS
                    </p>
