    ...
    <Reveal delay={120}>
      <section aria-label="おすすめの次のアクション" className="mt-10">
        <GlassCard
          padding="lg"
          magnetic={false}
          className="border border-[rgba(27,63,229,0.18)] bg-[linear-gradient(135deg,rgba(241,226,216,0.98),rgba(251,248,243,0.98))] shadow-soft-card"
        >
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div className="space-y-3 md:max-w-[70%]">
              <span
                aria-label="PR"
                className="inline-flex w-fit rounded-full border border-[rgba(27,63,229,0.24)] bg-[rgba(241,226,216,0.85)] px-3 py-1 text-[10px] font-semibold tracking-[0.22em] text-[var(--accent-base)] uppercase"
              >
                PR
              </span>
              ...
              <h2 className="font-sans text-[22px] font-semibold leading-[1.28] tracking-[-0.03em] text-[var(--text-primary)] sm:text-[26px]">
                {heading}
              </h2>
