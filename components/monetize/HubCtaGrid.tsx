        ...
        {items.map((it) => {
          ...
          return (
            <Reveal key={it.href}>
              ...
              >
                <GlassCard className="group flex h-full flex-col border border-[var(--border-default)] bg-[var(--surface-1)] p-5 shadow-soft transition hover:-translate-y-[1px] hover:border-[rgba(122,135,108,0.32)] sm:p-6">
                  ...
                  <h3 className="mt-4 font-serif text-[18px] font-semibold tracking-tight text-[var(--text-primary)]">
                    {it.title}
                  </h3>
