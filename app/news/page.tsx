          ...
          <Reveal delay={220}>
            <div className="mt-4 flex flex-wrap gap-2 text-[10px]">
              ...
              <Link
                ...
                rel="nofollow"
                className="inline-flex items-center gap-1 rounded-full border border-sky-100 bg-sky-50/90 px-3 py-1 tracking-[0.16em] text-[#222222]/80 transition hover:border-sky-300 hover:bg-sky-50"
              >
              ...
              <Link
                href="/news"
                className="inline-flex items-center gap-1 rounded-full border border-[#222222]/10 bg-white/80 px-3 py-1 tracking-[0.16em] text-[#222222]/70 transition hover:border-tiffany-300 hover:bg-white"
              >
                全期間
              </Link>
            </div>
            ...
            <form className="space-y-4 text-xs sm:text-[11px]">
              <div className="grid gap-3 md:grid-cols-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-full border border-[#222222]/10 bg-white px-3 py-2 text-xs text-[#222222] outline-none ring-0 transition focus:border-tiffany-400 focus:bg-white"
                  />
                </div>
              ...
              <div className="mt-2 flex items-center justify-end gap-3">
                {hasFilter && (
                  <Link
                    href="/news"
                    className="text-[10px] tracking-[0.16em] text-[#222222]/45 hover:text-[#222222]/80"
                  >
                    CLEAR
                  </Link>
                )}
        ...
        {hasFilter && (
          <Reveal delay={280}>
            <div className="mb-6 flex flex-wrap items-center gap-2 text-[10px]">
              <span className="rounded-full bg-[#222222]/03 px-2 py-0.5 text-[#222222]/45">
                ACTIVE FILTERS
              </span>
              {q && (
                <span className="rounded-full bg-white/80 px-2 py-0.5 text-[#222222]/80 shadow-[0_0_0_1px_rgba(148,163,184,0.4)]">
                    ...
                    {quickSources.slice(0, 10).map((s) => {
                      ...
                      return (
                        <Link
                          ...
                          rel="nofollow"
                          className="inline-flex items-center gap-1 rounded-full bg-[#222222]/03 px-3 py-1 tracking-[0.14em] transition hover:bg-white hover:text-tiffany-700 hover:shadow-soft"
                        >
                          <span>{s}</span>
                          {count > 0 && (
