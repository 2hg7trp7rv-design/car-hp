    ...
    <section id="reading" className="mb-12 scroll-mt-28">
      <Reveal>
        <div className="mb-5">
          ...
          <h2 className="cb-sans-heading mt-2 text-xl text-[var(--text-primary)]">{title}</h2>
          {lead ? (
          ...
          >
            <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div className="flex items-start gap-3">
                <span className="mt-0.5 inline-flex h-7 items-center rounded-full bg-[rgba(27,63,229,0.08)] px-3 text-[10px] font-semibold tracking-[0.22em] text-[var(--text-secondary)]">
                  観点 {idx + 1}
                </span>
                <div>
