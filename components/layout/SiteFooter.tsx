...
export function SiteFooter({ variant = "default" }: SiteFooterProps) {
  ...
  if (variant === "editorialArticle") {
    return (
      <footer className="border-t border-[rgba(50,43,35,0.10)] bg-[#eee7da] text-[#201d19]">
        <div className="mx-auto flex w-full max-w-[1180px] flex-col gap-5 px-6 py-9 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          <div>
            <p className="text-[10px] font-semibold tracking-[0.30em] text-[rgba(32,29,25,0.48)]">CAR BOUTIQUE JOURNAL</p>
            <p className="mt-2 text-[12px] leading-[1.8] text-[rgba(32,29,25,0.54)]">© {year} CB Journal</p>
          </div>
          <div className="flex flex-wrap gap-x-5 gap-y-2 text-[11px] font-semibold tracking-[0.18em] text-[rgba(32,29,25,0.48)]">
