...
export const metadata: Metadata = {
  title: "売却相場｜まず相場を掴んで、判断を早くする",
  description:
    "査定前に相場を押さえるだけで、迷いと損が減ります。比較の前の短い手順をまとめました。",

  alternates: { canonical: `${getSiteUrl()}/guide/hub-sell-price` },
};
      ...
      <div className="container mx-auto px-4 md:max-w-4xl">
        ...
        <Reveal>
          <header className="mb-10">
            ...
            <h1 className="serif-heading mt-2 text-3xl text-[var(--text-primary)]">売却相場</h1>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="serif-heading text-xl text-[var(--text-primary)]">最短チェック</h2>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(31,28,25,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-slate)]">要点</p>
              ...
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(31,28,25,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-slate)]">注意</p>
