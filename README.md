...
### Cars 本文（長文）の置き場所（content/cars）
- 企画書の「Carsは 2000〜6000字（意思決定支援）」を回すために、Cars は **長文本文を Markdown ファイルで追加**できます。
- 置き場所: `content/cars/<slug>.md`
  - 例: `content/cars/toyota-supra-jza80-rz.md`
- 反映箇所:
  - `/cars/[slug]` の各セクション（結論/チェック/弱点…）に追記として表示
  - Indexability 判定（A/B/C）と sitemap-cars の採用判定に本文長が反映されます
