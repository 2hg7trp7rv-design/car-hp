...
//
// All detail pages (GUIDE / COLUMN) share one fixed hero
...
export function DetailFixedBackground(
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      {/* Grain (very subtle) */}
      <div className="absolute -inset-[18%] opacity-[0.04] mix-blend-multiply pointer-events-none [background-image:repeating-linear-gradient(0deg,rgba(31,28,25,0.035)_0_1px,rgba(0,0,0,0)_1px_3px),repeating-linear-gradient(90deg,rgba(31,28,25,0.025)_0_1px,rgba(0,0,0,0)_1px_4px)] [transform:rotate(6deg)]" />
    </div>
  );
}
