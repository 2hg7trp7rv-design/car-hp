...
export function HeroSection() {
  return (
    <section className="relative h-[78vh] min-h-[560px] w-full overflow-hidden rounded-[2.5rem] bg-obsidian shadow-soft-strong">
        ...
        <div className="max-w-3xl">
          ...
          <Reveal delay={380}>
            <div className="mt-9 flex flex-wrap items-center gap-4">
              ...
              {/* 補助情報（PCでのみ表示） */}
              <div className="hidden min-w-[180px] flex-1 text-[10px] text-slate-300/80 sm:block">
                <div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 shadow-glass-edge backdrop-blur">
                  ...
                  <span className="tracking-[0.16em]">
                    NEWS / COLUMN / GUIDE 連動
                  </span>
                </div>
                <p className="mt-2 leading-relaxed tracking-[0.03em]">
                  まずは気になる車種のページから、
                  関連ニュースとコラムをセットで読み進めるのがおすすめです。
                </p>
              </div>
            </div>
          </Reveal>
          ...
          {/* 小さな統計・特徴チップ */}
          <Reveal delay={480}>
            <div className="mt-8 flex flex-wrap gap-2 text-[10px] text-slate-200/80">
