...
export default async function CarsPage({ searchParams }: PageProps) {
  ...
  if (sedanToken) {
    pushPreset(
      "セダンだけ",
      { bodyType: sedanToken },
      "cb-tap inline-flex items-center rounded-full border border-[#222222]/12 bg-white px-3 py-2 text-[10px] font-semibold tracking-[0.18em] text-[#222222] transition hover:border-[#0ABAB5]/35",
    );
  }
  ...
  return (
    <main className="relative min-h-screen text-white">
      <DetailFixedBackground imageSrc="/images/exhibit/kv-cars.webp" noUpscale />
      <JsonLd id="jsonld-cars-index-breadcrumb" data={breadcrumbData} />
      <div className="page-shell pb-32 pt-24">
        {/* top */}
        <div className="flex items-center justify-between">
          <Breadcrumb tone="light" items={[{ label: "HOME", href: "/" }, { label: "CARS" }]} />
        </div>
        ...
        {/* 3入口 */}
        <div className="mx-auto mt-8 max-w-5xl grid grid-cols-1 gap-3 sm:grid-cols-3">
          <Link
            href="/cars/makers"
            className="group flex items-center gap-4 rounded-2xl border border-white/12 bg-white/[0.05] px-5 py-4 backdrop-blur transition-all duration-300 hover:border-[#0ABAB5]/45 hover:bg-white/[0.09]"
          >
            <div>
              <p className="text-[11px] font-semibold tracking-[0.18em] text-white/90 transition-colors group-hover:text-[#0ABAB5]">
                メーカーから
              </p>
              <p className="mt-0.5 text-[11px] text-white/45">ブランドで絞り込む</p>
            </div>
            <span className="ml-auto text-[11px] text-white/30 group-hover:text-[#0ABAB5]/60">→</span>
          </Link>
          <Link
          ...
          >
            <div>
              ...
              <p className="mt-0.5 text-[11px] text-white/45">形・スタイルで絞り込む</p>
            </div>
            <span className="ml-auto text-[11px] text-white/30 group-hover:text-[#0ABAB5]/60">→</span>
          </Link>
          <Link
          ...
          >
            <div>
              ...
              <p className="mt-0.5 text-[11px] text-white/45">複数車種を並べて判断する</p>
            </div>
            <span className="ml-auto text-[11px] text-white/30 group-hover:text-[#0ABAB5]/60">→</span>
          </Link>
        </div>

        <div className="porcelain porcelain-panel mx-auto mt-10 max-w-5xl overflow-hidden rounded-3xl border border-[#222222]/10 bg-white/92 text-[#222222] shadow-soft-card backdrop-blur">
          <div className="p-6 sm:p-8">

	      	{/* 絞り込みフォーム（開閉式） */}
        <Reveal delay={200}>
          <section className="rounded-2xl border border-[#222222]/10 bg-white shadow-soft">
            <details className="group">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5 [&::-webkit-details-marker]:hidden">
                ...
                <span className="cb-tap inline-flex shrink-0 items-center gap-2 rounded-full border border-[#222222]/12 bg-[#222222]/5 px-4 py-2 text-[10px] font-semibold tracking-[0.22em] text-[#222222]/70 transition group-open:bg-[#222222]/10">
                  FILTER
...
<form id="cars-filter-form" method="get" action="/cars" className="space-y-4 text-xs sm:text-[11px]">
              ...
              <div className="grid gap-3 md:grid-cols-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full cb-tap rounded-2xl border border-[#222222]/12 bg-white px-3 py-2 text-xs text-[#222222] outline-none ring-0 transition focus:border-[#0ABAB5]/45"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1 grid grid-cols-2 gap-2">
                    <input
                      ...
                      placeholder="最小"
                      className="w-full cb-tap rounded-2xl border border-[#222222]/12 bg-white px-3 py-2 text-xs text-[#222222] outline-none ring-0 transition focus:border-[#0ABAB5]/45"
                    />
                    <input
                      type="number"
                      inputMode="numeric"
              ...
              <div className="mt-1">
                <div className="flex flex-col gap-1.5 text-[10px] text-[#222222]/55">
                  <p className="font-medium tracking-[0.22em] text-[#222222]/55">クイック絞り込み</p>
              ...
              <div className="mt-3 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2 text-[10px] text-[#222222]/55">
                  ...
                  <div className="inline-flex rounded-full bg-[#222222]/5 p-1">
                    <Link
                      ...
                      rel="nofollow"
                      className={`cb-tap inline-flex items-center justify-center rounded-full px-4 py-2 text-[10px] tracking-[0.16em] ${
                        viewMode === "card"
                ...
                <div className="flex items-center gap-3">
                  {hasFilter && (
                    <Link href="/cars" className="cb-tap inline-flex items-center px-3 text-[10px] tracking-[0.16em] text-[#222222]/55 hover:text-[#222222]/70">
                      CLEAR
                    </Link>
                  )}
                  <Button
        ...
        {(hasFilter || viewMode === "list" || perPage !== 12) && (
          <Reveal delay={230}>
            <div className="mb-6 flex flex-wrap items-center gap-2 text-[10px]">
              ...
              {q && (
                <Link
                  href={buildQueryString(baseQueryParams, { q: "", page: "1" })}
                  rel="nofollow"
                ...
                >
                  ...
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
                </Link>
              )}
              ...
              {makerKeyFilter && (
                <Link
                  ...
                  rel="nofollow"
                  className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/12 bg-white px-3 text-[#222222]/70 transition hover:border-[#0ABAB5]/35 hover:text-[#222222]"
                  aria-label={`Remove maker filter: ${makerLabelFilter}`}
                >
                  <span>
                    maker:<span className="ml-1 font-semibold">{makerLabelFilter}</span>
                  </span>
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
              ...
              {bodyTypeFilter && (
                <Link
                  ...
                  rel="nofollow"
                  className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/12 bg-white px-3 text-[#222222]/70 transition hover:border-[#0ABAB5]/35 hover:text-[#222222]"
                  aria-label={`Remove body filter: ${bodyTypeFilter}`}
                >
                  <span>
                    body:<span className="ml-1 font-semibold">{bodyTypeFilter}</span>
                  </span>
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
              ...
              {segmentFilter && (
                <Link
                  ...
                  rel="nofollow"
                  className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/12 bg-white px-3 text-[#222222]/70 transition hover:border-[#0ABAB5]/35 hover:text-[#222222]"
                  aria-label={`Remove segment filter: ${segmentFilter}`}
                >
                  <span>
                    segment:<span className="ml-1 font-semibold">{segmentFilter}</span>
                  </span>
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
              ...
              {priceBandFilter && (
                <Link
                  ...
                  rel="nofollow"
                  className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/12 bg-white px-3 text-[#222222]/70 transition hover:border-[#0ABAB5]/35 hover:text-[#222222]"
                  aria-label={`Remove price band filter: ${priceBandFilter}`}
                >
                  <span>
                    band:<span className="ml-1 font-semibold">{priceBandFilter}</span>
                  </span>
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
              ...
              {sortKey && (
                <Link
                  ...
                  rel="nofollow"
                  className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/12 bg-white px-3 text-[#222222]/70 transition hover:border-[#0ABAB5]/35 hover:text-[#222222]"
                  aria-label={`Remove sort: ${mapSortLabel(sortKey)}`}
                >
                  <span>
                    sort:<span className="ml-1 font-semibold">{mapSortLabel(sortKey)}</span>
                  </span>
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
              ...
              {perPage !== 12 && (
                <Link
                  ...
                  rel="nofollow"
                  className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/12 bg-white px-3 text-[#222222]/70 transition hover:border-[#0ABAB5]/35 hover:text-[#222222]"
                  aria-label="Reset rows per page"
                >
                  <span>
                    rows:<span className="ml-1 font-semibold">{perPage}件/ページ</span>
                  </span>
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
              ...
              {viewMode === "list" && (
                <Link
                  ...
                  rel="nofollow"
                  className="cb-tap inline-flex items-center gap-2 rounded-full border border-[#222222]/12 bg-white px-3 text-[#222222]/70 transition hover:border-[#0ABAB5]/35 hover:text-[#222222]"
                  aria-label="Switch view to card"
                >
                  <span>
                    view:<span className="ml-1 font-semibold">LIST</span>
                  </span>
                  <span aria-hidden="true" className="text-[#222222]/35">
                    ×
                  </span>
                  ...
                  {paged.map((car) => (
                    <tr id={`car-${car.slug}`} key={car.id} className="hover:bg-[#222222]/5">
                      ...
                      <td className="px-4 py-3 align-top text-[10px] text-[#222222]/70">
                        {car.releaseYear ? `${car.releaseYear}年頃` : "年式情報を準備中"}
                      </td>
            ...
            <nav className="mt-6 flex justify-center" aria-label="ページネーション">
              <div className="inline-flex items-center gap-1 rounded-full border border-[#222222]/10 bg-white px-2 py-1 text-[10px] shadow-soft">
                <Link
                  ...
                  rel="nofollow"
                  className={`cb-tap inline-flex items-center justify-center rounded-full px-3 py-1 ${
                    currentPage === 1
                      ? "text-[#222222]/25"
