      ...
      <div className="detail-shell pb-24 pt-10 sm:pt-12">
        ...
        <section className="mt-6 grid gap-4 lg:grid-cols-[minmax(0,1.12fr)_360px]">
          ...
          <div className="space-y-4">
            ...
            {takeaways.length > 0 ? (
              <section className="detail-card-moss p-6">
              ...
              <div key={sec.id} className={`${getEditorialSurfaceClass(idx)} overflow-hidden`}>
                ...
                <div className="px-6 py-6 sm:px-8 sm:py-7">
                  {isBase && checkPoints.length > 0 ? (
                    <div className="detail-card-slate mb-6 p-5">
                    ...
                    {sec.blocks.map((b, i) => {
                      ...
                      if (b.type === "details") {
                        return (
                          ...
                          >
                            <summary
                              className="cb-tap flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-4 text-[13px] text-[var(--text-secondary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[rgba(122,135,108,0.4)] [&::-webkit-details-marker]:hidden"
                            >
                            ...
                            <div className="mx-4 h-px bg-[rgba(31,28,25,0.08)]" />
                      ...
                      if (b.type === "hr") {
                        return <div key={i} className="h-px bg-[rgba(31,28,25,0.08)]" />;
                      }
                      return null;
                    })}
