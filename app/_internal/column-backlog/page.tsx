...
export default async function ColumnBacklogPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-10">
      <div className="mb-6">
        <p className="text-[11px] tracking-[0.22em] text-slate-500">INTERNAL / COLUMN BACKLOG</p>
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-slate-900">COLUMN Backlog</h1>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3 text-[13px] text-slate-700">
          <span className="rounded-full border border-slate-200 bg-white px-3 py-1">Total: {total}</span>
          <span className="rounded-full border border-slate-200 bg-white px-3 py-1">Draft: {draft}</span>
          <span className="rounded-full border border-slate-200 bg-white px-3 py-1">Published: {published}</span>
          <span className="rounded-full border border-slate-200 bg-white px-3 py-1">Archived: {archived}</span>
