...
const nextConfig = {
  ...
  experimental: {
    // Keep local/Vercel builds deterministic. Higher worker counts have caused
    // the large static article build to stall during page generation/tracing in constrained runtimes.
    cpus: 1,
    workerThreads: false,
