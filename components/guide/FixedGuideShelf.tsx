        ...
        <Reveal>
          <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <h2 className="serif-heading mt-2 text-lg font-semibold text-[var(--text-primary)] sm:text-xl">
                {title}
              </h2>
          ...
          {cards.map((card, index) => (
            <Reveal key={card.href} delay={80 + index * 40}>
              <TrackedLink
                ...
                toId={card.toId}
              >
                <GlassCard className="group h-full border border-[rgba(31,28,25,0.12)] bg-[var(--surface-1)] p-5 text-xs shadow-soft transition hover:-translate-y-[1px] hover:border-accent-100 hover:shadow-soft-card">
