      ...
      <div className="container mx-auto px-4 md:max-w-4xl">
        ...
        <Reveal>
          <header className="mb-10">
            <p className="text-[10px] font-semibold tracking-[0.3em] text-[var(--accent-base)]"></p>
            <h1 className="cb-sans-heading mt-2 text-3xl text-[var(--text-primary)]">査定準備</h1>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="cb-sans-heading text-xl text-[var(--text-primary)]">準備チェック</h2>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(14,12,10,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-base)]">確認</p>
              ...
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(14,12,10,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-base)]">方針</p>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="cb-sans-heading text-xl text-[var(--text-primary)]">次に読む</h2>
            <p className="mt-2 text-[12px] leading-relaxed text-[rgba(76,69,61,0.82)]">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] px-4 py-2 text-[11px] font-semibold tracking-[0.18em] text-[rgba(14,12,10,0.8)] hover:border-[rgba(27,63,229,0.3)] hover:text-[var(--accent-strong)]"
              >
                相場の目安へ
              </Link>
              <Link
