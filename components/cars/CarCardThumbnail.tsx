  ...
  return (
    <div className="w-full overflow-hidden rounded-[22px] border border-[var(--border-default)] bg-[var(--surface-1)]">
      <div className="relative aspect-[16/9] w-full">
        ...
        {!showPlaceholder && (
          <div className="pointer-events-none absolute bottom-2 right-2 rounded-full border border-[rgba(14,12,10,0.12)] bg-[rgba(251,248,243,0.88)] px-2.5 py-1 text-[9px] font-medium tracking-[0.16em] text-[var(--text-primary)] shadow-sm backdrop-blur-sm">
            読む
          </div>
        )}
      </div>
