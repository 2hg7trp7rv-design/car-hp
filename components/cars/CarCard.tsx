          ...
          >
            ...
            >
              <div className={cn("relative overflow-hidden", mediaClass)}>
                ...
                />
                <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(251,248,243,0.02),rgba(14,12,10,0.18))]" />
              </div>
              ...
              >
                <div className="flex flex-wrap items-center gap-2">
                  {car.maker ? (
                    <span className="rounded-full border border-[rgba(27,63,229,0.18)] bg-[var(--accent-subtle)] px-3 py-1 text-[10px] font-semibold tracking-[0.18em] text-[var(--accent-strong)]">
                      {car.maker}
                    </span>
                  ) : null}
                  {car.releaseYear ? (
                ...
                {meta ? (
                  <div className="mt-4 flex flex-wrap gap-2">
                    {meta.split(" / ").map((item) => (
                      <span
                        key={item}
                        className="rounded-full border border-[rgba(14,12,10,0.08)] bg-[var(--surface-2)] px-3 py-1 text-[10px] tracking-[0.14em] text-[var(--text-tertiary)]"
                      >
                        {item}
                      </span>
                    ))}
