    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          "cb-tap border border-black/15 bg-white/85 px-3 py-2 backdrop-blur",
          "text-[11px] font-medium tracking-[0.18em] text-black",
          "transition-colors duration-300",
          "hover:border-black/30",
          open && "border-black/55",
        )}
      >
      ...
      >
        ...
        <button
          ...
          className="cb-menu-backdrop absolute inset-0 bg-white"
        />
        <div aria-hidden="true" className="pointer-events-none absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-white/90 to-white" />
          <div className="absolute -inset-[20%] opacity-[0.10] mix-blend-multiply [background-image:repeating-linear-gradient(0deg,rgba(0,0,0,0.06)_0_1px,rgba(0,0,0,0)_1px_2px),repeating-linear-gradient(90deg,rgba(0,0,0,0.05)_0_1px,rgba(0,0,0,0)_1px_3px)] [transform:rotate(7deg)]" />
        </div>
        ...
        <div className="safe-area-top safe-area-bottom safe-area-left safe-area-right absolute inset-0 overflow-y-auto">
          <div className="mx-auto flex max-w-5xl flex-col px-4 pb-14 pt-20 sm:px-6 lg:px-8">
            <div className="flex items-start justify-between gap-8">
              <div>
                <p className="text-[11px] tracking-[0.18em] text-black/60">
                  CAR BOUTIQUE JOURNAL
                </p>
                <p className="mt-5 text-[clamp(22px,3vw,34px)] font-medium tracking-[0.06em] text-black">
                  MENU
                </p>
              </div>
            ...
            <nav className="mt-12" aria-label="Global navigation">
                  ...
                  <li key={it.href} className="border-b border-black/10 pb-8">
                    <Link
                      href={it.href}
                    ...
                    >
                      <div className="flex items-baseline gap-6">
                        <span className="text-[11px] tracking-[0.18em] text-black/45">
                          {String(idx + 1).padStart(2, "0")}
                        </span>
                        <span className="text-[18px] font-medium tracking-[0.06em] transition-colors duration-300 group-hover:underline underline-offset-4">
                          {it.label}
                        </span>
                      </div>
                    </Link>
