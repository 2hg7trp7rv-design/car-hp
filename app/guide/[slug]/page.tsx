    ...
    <main className="min-h-screen bg-[#fafafa] text-[#222222]">
      ...
      <div className="mx-auto max-w-[820px] px-4 pb-24 pt-24 sm:px-6">
        ...
        <section className="mt-10">
          <div className="rounded-3xl border border-[#222222]/10 bg-[#f5f7f9] p-6 shadow-soft">
            <p className="text-[10px] font-semibold tracking-[0.22em] text-[#222222]/55">
              PILLAR
            </p>
            <p className="mt-2 text-[13px] leading-relaxed tracking-[0.06em] text-[#374151]">
              {pillar.description}
            </p>
            <Link
              href={pillar.href}
              className="cb-tap mt-4 inline-flex items-center gap-2 rounded-full border border-[#222222]/10 bg-white px-4 py-2 text-[11px] font-semibold tracking-[0.18em] text-[#222222] hover:border-[#0ABAB5]/35"
            >
              {pillar.label}へ戻る
...
{/* toc */}
              ...
              <div className="mt-12 space-y-6">
                {guide.updateReason ? (
                  <section className="overflow-hidden rounded-3xl border border-[#222222]/10 bg-[#f5f7f9] p-6 shadow-soft">
                    <h2 className="serif-heading text-[18px] tracking-tight text-[#111111]">更新履歴</h2>
        ...
        <div className="mt-14 flex flex-wrap gap-3">
          <Link
            href="#top"
            className="cb-tap inline-flex items-center rounded-full border border-[#222222]/10 bg-white px-4 py-2 text-[11px] font-semibold tracking-[0.18em] text-[#222222] hover:border-[#0ABAB5]/35"
          >
