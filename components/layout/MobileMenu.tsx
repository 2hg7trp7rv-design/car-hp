    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          <nav className="porcelain absolute inset-x-4 top-16 mx-auto max-w-md rounded-[24px] border border-[var(--border-default)] bg-[rgba(251,248,243,0.98)] p-5 shadow-[0_24px_60px_rgba(14,12,10,0.16)]">
            <div className="flex items-center justify-between gap-3">
              <div>
                <p className="cb-sans-heading text-[15px] font-medium tracking-[0.16em] text-[var(--text-primary)]">
                  ...
                  <li key={item.href}>
                    <Link
                      ...
                      className={[
                        ...
                        active
                          ? "border-[rgba(27,63,229,0.24)] bg-[var(--surface-glow)] text-[var(--text-primary)]"
