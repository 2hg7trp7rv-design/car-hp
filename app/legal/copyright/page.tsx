    ...
    <>
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-[12px] leading-relaxed text-[#222222]/65 sm:text-sm">
          CAR BOUTIQUE JOURNALに掲載される文章・画像などの取り扱いと、ニュースソース等の外部コンテンツをどのように扱うかについての方針です。
        </p>
      </header>
      ...
      <div className="mt-10 space-y-10">
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          ...
          <ul className="ml-5 list-disc space-y-1">
            ...
            <li>
              出典として当サイト名(CAR BOUTIQUE JOURNAL)と該当ページのURLを明記すること
            </li>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-[#222222]/80">
          <h2 className="text-lg font-semibold text-[#222222]">6. ポリシーの変更</h2>
          <p>
