      ...
      <div className="container mx-auto px-4 md:max-w-4xl">
        ...
        <Reveal>
          <header className="mb-10">
            ...
            <h1 className="cb-sans-heading mt-2 text-3xl text-[var(--text-primary)]">売却相場</h1>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="cb-sans-heading text-xl text-[var(--text-primary)]">最短チェック</h2>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(14,12,10,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-base)]">要点</p>
              ...
              <GlassCard className="border border-[var(--border-default)] bg-[rgba(228,219,207,0.42)] p-5 text-[rgba(14,12,10,0.86)] shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-[var(--accent-base)]">注意</p>
