    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          "border border-white/15 bg-black/35 px-3 py-2 backdrop-blur",
          "text-[11px] font-medium tracking-[0.34em] text-white",
        ...
        <div className="safe-area-top safe-area-bottom safe-area-left safe-area-right absolute inset-0 overflow-y-auto">
          <div className="mx-auto flex max-w-5xl flex-col px-4 pb-14 pt-20 sm:px-6 lg:px-8">
            <div className="flex items-start justify-between gap-8">
              <div>
                <p className="text-[11px] tracking-[0.34em] text-white/60">
                  CAR BOUTIQUE JOURNAL
                </p>
                <p className="mt-5 text-[clamp(22px,3vw,34px)] font-medium tracking-[0.12em] text-white">
                  MENU
                </p>
              </div>
                  ...
                  <li key={it.href} className="border-b border-white/10 pb-8">
                    ...
                    >
                      <div className="flex items-baseline gap-6">
                        <span className="text-[11px] tracking-[0.34em] text-white/45">
