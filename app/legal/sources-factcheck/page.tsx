    ...
    <>
      ...
      <div className="mt-10 space-y-10">
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">1. 優先する情報源</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">2. 要約と表現</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">3. 数値・仕様の扱い</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">4. 誤りの報告と修正</h2>
          <p>
        ...
        <section className="space-y-3 text-[13px] leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-slate-900">5. 外部リンクについて</h2>
          <p>
