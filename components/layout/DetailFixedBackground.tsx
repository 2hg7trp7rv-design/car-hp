...
export function DetailFixedBackground(
  ...
  const srcRaw = (props.imageSrc ?? "").trim();
  const safe = srcRaw.startsWith("/") ? srcRaw : "";

  const desktopSrc = safe || "/images/hero-top-desktop.jpeg";
  const mobileSrc = safe || "/images/hero-top-mobile.jpeg";
  const isCustom = Boolean(safe);
      ...
      <picture>
        ...
        <img
          ...
          className={
            ...
            (isCustom
              ? "object-center opacity-45 saturate-80 brightness-85 contrast-110"
              : "object-[55%_35%] opacity-55 saturate-50 brightness-90 contrast-110")
          }
          loading="eager"
        />
      </picture>
