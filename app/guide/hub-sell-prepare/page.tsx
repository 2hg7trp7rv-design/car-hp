      ...
      <div className="container mx-auto px-4 md:max-w-4xl">
        <Reveal>
          <header className="mb-10">
            ...
            <h1 className="serif-heading mt-2 text-3xl text-slate-100">査定準備HUB</h1>
        ...
        <section className="mb-12">
          <Reveal>
            <h2 className="serif-heading text-xl text-slate-100">準備チェック</h2>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <GlassCard className="border border-slate-800 bg-slate-900/60 p-5 text-slate-200 shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-tiffany-300">CHECK</p>
              ...
              <GlassCard className="border border-slate-800 bg-slate-900/60 p-5 text-slate-200 shadow-soft">
                <p className="text-[11px] font-semibold tracking-[0.22em] text-tiffany-300">RULE</p>
