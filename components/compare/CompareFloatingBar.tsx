...
export function CompareFloatingBar() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3 rounded-full border border-slate-200/80 bg-white/92 px-3 py-2 shadow-soft-card backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Button variant="outline" size="xs" magnetic className="h-7 px-3">
              開く
            </Button>
          </TrackedLink>
