      ...
      <div className="detail-shell pb-24 pt-24 sm:pt-28">
        ...
        {summaryPoints.length > 0 ? (
          <section className="mt-8">
            <section className="detail-card-moss p-6 sm:p-8">
        ...
        {(turningPoints.length > 0 || timelineEvents.length > 0) ? (
          <section className="mt-8 grid gap-4 lg:grid-cols-[minmax(0,1.08fr)_360px]">
              ...
              <div className="detail-card p-6 sm:p-7">
                ...
                <div className="mt-4 space-y-4">
                  {turningPoints.map((point, idx) => (
                    <div key={`${point.label}-${idx}`} className="rounded-[22px] border border-[rgba(31,28,25,0.08)] bg-[rgba(251,248,243,0.82)] p-5">
            ...
            {timelineEvents.length > 0 ? (
              <div className="detail-card-slate p-6 sm:p-7">
                <p className="detail-kicker">年表</p>
                <div className="mt-4 space-y-4">
                  {timelineEvents.map((event, idx) => (
                    <div key={`${event.year}-${idx}`} className="relative pl-5">
                      <span className="absolute left-[4px] top-0 h-full w-px bg-[rgba(31,28,25,0.12)]" aria-hidden />
                      <span className="absolute left-0 top-[0.45em] h-[9px] w-[9px] rounded-full border border-[rgba(31,28,25,0.12)] bg-[var(--accent-slate)]" aria-hidden />
              ...
              <div className="px-6 py-6 sm:px-8 sm:py-7">
                <div className="space-y-8 cb-prose">
                  {c.blocks.map((b, bIdx) => {
                    ...
                    if (b.type === "hr") {
                      return <div key={bIdx} className="h-px w-full bg-[rgba(31,28,25,0.08)]" />;
                    }
                    return null;
                  })}
                </div>
              ...
              <div className="mt-4 flex gap-3 overflow-x-auto pb-2">
                {relatedCars.slice(0, 10).map((car) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border border-[rgba(31,28,25,0.08)] bg-[var(--surface-2)]">
