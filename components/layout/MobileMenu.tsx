    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          {/* メニュー本体 */}
          <nav className="absolute inset-x-4 top-16 mx-auto max-w-md rounded-3xl bg-white/95 p-5 shadow-[0_24px_60px_rgba(15,23,42,0.4)]">
            {/* ブランドヘッダー */}
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-[9px] tracking-[0.26em] text-slate-400">
                  NEWS・COLUMN・GUIDE・CARS・HERITAGE
                </p>
              </div>
              <button
                type="button"
            ...
            <p className="mt-3 text-[10px] leading-relaxed text-slate-500">
              ニュースとコラムと車種データベースをまとめて見られるスマホ前提のサイト。
              検討中の1台を起点にNEWS COLUMN GUIDE CARS HERITAGEを行き来しながら整理していく前提です。
            </p>
            ...
            <p className="mt-3 border-t border-slate-100 pt-3 text-[9px] leading-relaxed text-slate-400">
              とりあえずはNEWSで全体の動きを把握しつつ
              CARSで気になる車種を選び
              COLUMNとGUIDEでトラブルとお金まわりを確認
