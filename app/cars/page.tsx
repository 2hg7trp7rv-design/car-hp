    ...
    <main className="min-h-screen bg-site text-text-main">
      ...
      <div className="page-shell pb-32 pt-24">
        ...
        <header className="mt-10 text-center">
          <p className="text-[12px] tracking-[0.22em] text-[#0ABAB5]">CAR DATABASE</p>
          <h1 className="serif-heading mt-4 text-[44px] tracking-[0.08em] text-[#222222]">CARS</h1>
          <p className="mx-auto mt-5 max-w-2xl text-[13px] leading-relaxed text-[#222222]/65">
            メーカー・ボディタイプ・セグメント・年式・価格帯で絞り込み、候補を比較しやすくする車種DB。
          </p>
        </header>
              ...
              <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <ul className="mt-4 space-y-2 text-[12px] leading-relaxed text-[#222222]/70">
                    <li>・迷ったらまず「セグメント（サイズ感）」→「メーカー」の順で絞る。</li>
                    <li>・候補が2〜5台になったら、年式と価格帯で現実ラインへ落とす。</li>
                    <li>・比較が必要なら COMPARE を使う。</li>
                  </ul>
                  ...
                  <div className="mt-5 flex flex-wrap gap-2">
                    {[ 
                      ...
                      { href: "/start", label: "START（入口）" },
                    ].map((it) => (
                      <Link
                        key={it.href}
                        href={it.href}
                        className="inline-flex items-center rounded-full border border-[#222222]/12 bg-white px-3 py-2 text-[10px] font-semibold tracking-[0.18em] text-[#222222] transition hover:border-[#0ABAB5]/35"
                      >
                        {it.label}
                      </Link>
                    ))}
                ...
                <div className="grid grid-cols-3 gap-3 text-center">
                  <div className="rounded-2xl border border-[#222222]/10 bg-white px-3 py-3">
                    <div className="text-[10px] font-semibold tracking-[0.2em] text-[#222222]/55">
                      TOTAL
                    </div>
                    <div className="mt-1 text-2xl font-semibold text-[#222222]">{totalModels}</div>
                    <div className="mt-1 text-[10px] text-[#222222]/55">MODELS</div>
                  </div>
                  <div className="rounded-2xl border border-[#222222]/10 bg-white px-3 py-3">
                    <div className="text-[10px] font-semibold tracking-[0.2em] text-[#222222]/55">
                      MAKERS
                    </div>
                    <div className="mt-1 text-2xl font-semibold text-[#222222]">{makerInfos.length}</div>
                    <div className="mt-1 text-[10px] text-[#222222]/55">BRANDS</div>
                  </div>
                  <div className="rounded-2xl border border-[#222222]/10 bg-white px-3 py-3">
                    <div className="text-[10px] font-semibold tracking-[0.2em] text-[#222222]/55">
                      SEG.
                    </div>
                    <div className="mt-1 text-2xl font-semibold text-[#222222]">{segments.length}</div>
                    <div className="mt-1 text-[10px] text-[#222222]/55">SIZES</div>
                  </div>
                </div>
              </div>

              <p className="mt-5 text-[11px] leading-relaxed text-[#222222]/55">
                現在の表示: <span className="font-semibold text-[#222222]">{totalFiltered}</span>
              </p>
            </div>
          </div>
        </section>
        ...
        {/* 絞り込みフォーム */}
        <Reveal delay={200}>
          <section className="mx-auto mt-10 max-w-5xl rounded-2xl border border-[#222222]/10 bg-white p-6 shadow-soft">
            ...
            <div className="overflow-hidden rounded-2xl border border-[#222222]/10 bg-white">
              <table className="min-w-full divide-y divide-slate-100 text-[11px]">
                ...
                <tbody className="divide-y divide-slate-100">
                  {paged.map((car) => (
                    <tr key={car.id} className="hover:bg-[#222222]/5">
