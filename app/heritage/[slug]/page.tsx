              ...
              >
                <div className="space-y-5">
                  {c.blocks.map((b, bIdx) => {
                    if (b.type === "paragraph") {
                      return (
                        <p key={bIdx} className="text-[14px]">
                          {renderSentenceBreaks(b.text)}
                        </p>
                      );
                    }
                    if (b.type === "heading") {
                      return (
                        <h3
                          key={bIdx}
                          id={b.heading.id}
                          className="serif-heading scroll-mt-28 text-[16px] text-white"
                        >
                          {b.heading.text}
                        </h3>
                      );
                    ...
                    if (b.type === "list") {
                      return (
                        <ul key={bIdx} className="space-y-2">
                          {b.items.map((t, i2) => (
                            <li key={i2} className="flex gap-3 text-[14px]">
