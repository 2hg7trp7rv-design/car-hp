...
export function ArchiveEntrance(props: {
  ...
  const items = [
    { key: "cars" as const, n: "01", label: "CARS", href: "/cars" },
    { key: "heritage" as const, n: "02", label: "HERITAGE", href: "/heritage" },
    { key: "guide" as const, n: "03", label: "GUIDES", href: "/guide" },
    { key: "column" as const, n: "04", label: "COLUMNS", href: "/column" },
  ];

  return (
    <section className={styles.wrap} aria-label="Archive entrance">
