            ...
            >
              <div
                className={[
                  ...
                  active
                    ? "border border-[rgba(122,135,108,0.24)] bg-[rgba(122,135,108,0.12)] text-[var(--accent-strong)]"
                    : "border border-transparent text-[var(--text-tertiary)] hover:border-[rgba(31,28,25,0.08)] hover:bg-[rgba(251,248,243,0.92)] hover:text-[var(--text-primary)]",
                ].join(" ")}
              >
