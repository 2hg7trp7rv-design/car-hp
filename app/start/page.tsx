              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="mt-2 max-w-xl text-[12px] leading-relaxed text-[#222222]/70">
                    迷ったら、HOME / CARS / GUIDE / COLUMN / HERITAGE の5つから入れば大丈夫です。検索や比較ではなく、まずは主カテゴリから現在地を合わせます。
                  </p>
                </div>
                ...
                <div className="flex w-full max-w-xl flex-wrap items-center justify-end gap-2">
                  ...
                  <Button asChild variant="outline" size="sm" className="h-10 px-5">
                    <Link href="/cars">CARSへ</Link>
                  </Button>
                  <Button asChild variant="outline" size="sm" className="h-10 px-5">
                    <Link href="/guide">GUIDEへ</Link>
                  </Button>
                  <Button asChild variant="outline" size="sm" className="h-10 px-5">
                    <Link href="/column">COLUMNへ</Link>
                  </Button>
                  <Button asChild variant="outline" size="sm" className="h-10 px-5">
                    <Link href="/heritage">HERITAGEへ</Link>
                  </Button>
                </div>
              </div>
            </GlassCard>
          ...
          <Reveal delay={200}>
            <GlassCard className="border border-[#222222]/10 bg-white/70 p-6" padding="none">
              ...
              <ol className="mt-3 space-y-2 text-[12px] leading-relaxed text-[#222222]/70">
                <li>
                  1. <span className="font-semibold text-[#222222]/85">GUIDE</span> で手順を読む
                </li>
                <li>
                  2. <span className="font-semibold text-[#222222]/85">COLUMN</span> で判断材料を増やす
                </li>
                <li>
                  3. 車そのものを見る時は <span className="font-semibold text-[#222222]/85">CARS</span> へ進む
                </li>
              </ol>
