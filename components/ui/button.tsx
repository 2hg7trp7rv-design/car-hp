...
const buttonVariants = cva(
  [
    ...
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(27,63,229,0.42)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-stage)]",
    ...
    variants: {
      variant: {
        ...
        outline: [
          ...
          "hover:border-[rgba(27,63,229,0.45)] hover:bg-[var(--surface-2)]",
          "active:scale-[0.99]",
        ].join(" "),
        subtle: [
