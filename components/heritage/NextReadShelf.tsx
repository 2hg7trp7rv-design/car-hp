...
export const NextReadShelf: React.FC<NextReadShelfProps> = ({
  ...
  return (
    <section className="border-t border-[rgba(14,12,10,0.12)] py-16">
      <div className="container mx-auto px-4" ref={ref}>
        <h3 className="mb-8 flex items-center justify-center gap-4 text-center font-sans text-2xl text-[var(--text-primary)]">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {items.map((item, idx) => {
            ...
            return (
              ...
              toId={item.slug}
              className="group relative block aspect-[3/4] overflow-hidden rounded-lg border border-[rgba(14,12,10,0.12)] bg-[rgba(228,219,207,0.42)] md:aspect-[4/5]"
            >
              {/* 背景画像 */}
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-[rgba(246,242,235,0.96)] via-[rgba(246,242,235,0.82)] to-transparent p-6">
                ...
                <h4 className="mb-2 font-sans text-xl font-medium leading-tight text-[var(--text-primary)] transition-colors group-hover:text-[var(--accent-base)]">
                  {item.title}
                </h4>
